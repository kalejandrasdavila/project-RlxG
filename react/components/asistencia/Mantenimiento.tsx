...
interface MantenimientoProps {
    // Aquí puedes definir los props que este componente recibirá si lo usas como un bloque de VTEX IO
    // Por ejemplo, si pasas el título o descripción desde el blocks.json
    // pageTitle?: string;
    // pageDescription?: string;
}

// Para que sea compatible con VTEX IO, puedes usar StorefrontFunctionComponent
// si tu app es de tipo 'store' y quieres que tenga acceso a ciertas APIs de Storefront.
const Mantenimiento: StorefrontFunctionComponent<MantenimientoProps> = ({ }) => {
    // Si useInitScripts contiene lógica importante, adáptala aquí con useEffect
    useEffect(() => {
        // Ejemplo: Si el script inicializa algo que depende del DOM.
        // Asegúrate de que los scripts externos (jQuery, Swiper) estén cargados
        // correctamente por VTEX IO antes de que esta lógica se ejecute.
        // Esto NO es el lugar para cargar los scripts con <script> tags.
        // console.log("Lógica de inicialización de scripts si es necesaria.");
    }, []);

    return (
        <>

            {/* Este bloque de script para el dataLayer de Rolex es un caso especial.
                Si es un script que *siempre* debe estar presente para esta página
                y no se puede definir de otra forma en VTEX, puedes dejarlo aquí.
                Sin embargo, lo ideal es usar la inyección de scripts a nivel de app
                o a través de Google Tag Manager (GTM) en VTEX IO.
                Para propósitos de conversión, lo mantenemos si es crítico.
            */}
            ...
            {/* Los JSON-LD (Schema.org) sí se pueden mantener en el componente si son específicos y estáticos para él. */}
                ...
                {JSON.stringify({
                    ...
                    "@graph": [
                        ...
                        },
                        {
                            ...
                            "description": "Explore el procedimiento de servicio Rolex en GLAUSER, su distribuidor oficial Rolex para obtener cuidado y mantenimiento experto de su reloj Rolex.",
            ...
            <div className="header-component">
                {/*<VTEXTemplate id="HeaderPromotion" />*/}
                {/*<VTEXTemplate id="GLHeader" />*/}
                <header className="main-header" id="main-header">
                    {/* <VTEXTemplate id="MainNav" />*/}
                </header>
            </div>
            ...
            <main id="rlx-html">
                    ...
                    <div className="rlx-container">
                        <div className="row-grid">
                            <div className="rlx-logo">
                                {/* Asegúrate de que las URLs de los enlaces sean relativas o manejadas por el router de VTEX IO */}
                            ...
                            <Nav /> {/* Asegúrate que 'Nav' sea un componente de VTEX IO */}
                        </div>
                        ...
                        <div className="row-grid breadcrum-page" style={{ height: "40px" }}>
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14">
                                        {/* URLs relativas */}
                                        <a href="/rolex/asistencia-rolex/">Mantenimiento</a>
                                    </li>
                                    <li className="fixed-14 active none-mobil">
                                        {/* URLs relativas */}
                                        <a className="active" href="/rolex/asistencia-rolex/mantenimiento-rolex/">Procedimiento de mantenimiento</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw text-introduccion pb-90-60">
                            ...
                            <div className="col-lg-8-5">
                                <p className="body-20-light">Cualquier Distribuidor Oficial o filial de la marca puede hacerse cargo de su reloj Rolex para su servicio. El personal competente registra sus posibles peticiones en el momento en que usted le entrega su reloj. A continuación, se envía a un relojero.</p>
                            </div>
                        </div>
                            ...
                            <div className="col-6-12">
                                <div className="banner-10 rlx-banner-100">
                                    <div className="ratio ratio-16x9">
                                        {/* Ajusta el src del iframe a la URL correcta de YouTube */}
                                        <iframe width="560" height="315" src="https://www.youtube.com/embed/YOUR_YOUTUBE_VIDEO_ID" title="Mantenimiento de tu Reloj Rolex" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="row-grid-fullw cuerpotexto py-90-60">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">Su reloj es minuciosamente examinado por un relojero, que estima las operaciones que hay que realizar y establece un presupuesto. Una vez aceptado, comienza el servicio de mantenimiento.</p>
                            </div>
                        </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">El movimiento, todavía coronado por la esfera y las agujas, se extrae de la caja, de la que se ha desprendido previamente el brazalete. Movimiento, caja y brazalete se tratarán de forma separada durante el proceso de mantenimiento, antes de volver a montarlos al concluir el servicio.</p>
                                </div>
                                <picture className="rlx-pbanner-top p-relative">
                        ...
                        <div className="col-text-center">
                            <div className="py-90-60">
                                ...
                                <p className="body-20-light">
                                    El movimiento se desmonta por completo y todos los componentes se
                                    examinan con el mayor de los cuidados. Los que no cumplen con los
                                    criterios de Rolex se sustituyen sistemáticamente.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center pb-90-60">
                                ...
                                <p className="body-20-light">Los diferentes componentes se limpian mediante baños de ultrasonidos, de tal modo que se eliminan las impurezas hasta en las zonas de más difícil acceso.</p>
                            </div>
                        </div>
                        <div className="row-grid-fullw image-center">
                            <div className="col-6-10">
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">Los componentes se secan y, a continuación, el movimiento se vuelve a montar por completo y se lubrica. El relojero ajusta una primera vez la precisión del movimiento de acuerdo con los criterios de la marca.</p>
                                </div>
                                <picture className="rlx-pbanner-top p-relative">
                    ...
                    <div className="row-grid-fullw cuerpotexto">
                        <div className="col-text-center">
                            <div className="py-90-60">
                                ...
                                <p className="body-20-light">
                                    La caja se desmonta por completo y la carrura, el bisel, el fondo y
                                    el brazalete se pulen o satinan, en función del acabado original.
                                    Estas sutiles operaciones exigen destreza y delicadeza.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">
                                        Una vez reavivados y limpios, los elementos de la caja se vuelven
                                        a montar y las juntas de hermeticidad se reemplazan. Se pone a
                                        prueba la hermeticidad de la caja.
                                    </p>
                                </div>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                    ...
                    <div className="row-grid-fullw cuerpotexto">
                        <div className="col-text-center">
                            <div className="py-90-60">
                                ...
                                <p className="body-20-light">
                                    El movimiento, sobre el cual se han vuelto a montar la esfera y las
                                    agujas, se recoloca en la caja después de que el relojero haya
                                    efectuado un riguroso control técnico y estético de todos los
                                    elementos.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center pb-90-60">
                                ...
                                <p className="body-20-light pb-30">
                                    Tras el encajado del movimiento, se evalúa una vez más la precisión
                                    cronométrica. El relojero procede a los últimos ajustes para que
                                    cumpla con las exigencias de Rolex.
                                </p>
                                <p className="body-20-light">
                                    A continuación, el relojero enrosca el fondo de la caja y entonces
                                    el reloj se pone a prueba, al menos durante veinticuatro horas. Esta
                                    prueba, propia de la marca, permite verificar el buen funcionamiento
                                    de su movimiento.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">
                                    La hermeticidad del reloj se controla con ayuda de una prueba
                                    realizada en el agua bajo presión y, a continuación, se vuelve a
                                    montar el brazalete en la caja.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center pb-90-60">
                                ...
                                <p className="body-20-light">
                                    El reloj ya está preparado para un control final. Durante el mismo,
                                    el relojero comprueba que sus funciones estén perfectamente
                                    operativas y que su estética sea irreprochable.
                                </p>
                            </div>
                        </div>
                        <div className="row-grid-fullw image-center">
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">
                                        Al concluir el servicio, se le devuelve el reloj en un estuche
                                        protector. El servicio tiene una garantía internacional de una
                                        duración de dos años que cubre tanto las piezas como la mano de
                                        obra.
                                    </p>
                                </div>
                                <picture className="rlx-pbanner-top p-relative">
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center pb-90-60">
                                ...
                                <p className="body-20-light">
                                    Rolex se compromete plenamente a ofrecerles a sus clientes un
                                    servicio posventa de primer nivel. Gracias a la exigencia y al
                                    savoir‑faire de nuestros relojeros, su reloj Rolex puede mantenerse
                                    en el tiempo conservando una excelente fiabilidad y, al mismo
                                    tiempo, un brillo irreprochable.
                                </p>
                            </div>
                        </div>
                        <div className="row-grid-fullw image-center">
                ...
                <RlxExploreMas /> {/* Asegúrate que 'RlxExploreMas' sea un componente de VTEX IO */}
                <Footer /> {/* Asegúrate que 'Footer' sea un componente de VTEX IO */}
            </main>
        </>
    );
}
...
// Definición del schema para VTEX IO si este componente es un bloque
Mantenimiento.schema = {
    title: 'Página de Mantenimiento Rolex',
    description: 'Componente principal para la página de procedimiento de mantenimiento Rolex.',
    type: 'object',
    properties: {}, // Aquí puedes añadir propiedades si quieres que el bloque sea configurable desde Site Editor
};