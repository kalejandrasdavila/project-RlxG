                ...
                <div className="rlx-container-content py-90-60">
                    <div className="row-grid-fullw component-video">
                        <div className="col-6-12">
                            <a href="http://localhost:3000/rolex/watches/cosmograph-daytona/">
                    ...
                    <div className="row-grid-fullw component-2-col">
                        <div className="col-lg-2-6">
                            <div className="pt-10">
                                ...
                                <a href="http://localhost:3000/rolex/watches/cosmograph-daytona/" className="btn-label-icon-rlx">Más información
...
export default SectionCosmoGraphD;