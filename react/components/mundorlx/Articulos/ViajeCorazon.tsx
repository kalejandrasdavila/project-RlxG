...
const ViajeCorazon: React.FC = () => {
    ...
    const currentUrl = (typeof window !== 'undefined' && window.location) ? window.location.href : 'https://glauser.myvtex.com/rolex/mundo-rolex/viaje-al-corazon-del-universo-rolex/';
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 active none-mobil">
                                        <a className="active" href="https://glauser.myvtex.com/rolex/mundo-rolex/viaje-al-corazon-del-universo-rolex/">Viaje al corazón del universo Rolex</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
