...
const FilaViena: React.FC = () => {
    ...
    const currentUrl = typeof window !== 'undefined' ? window.location.href : 'https://devjhernandez--glauser.myvtex.com/rolex/mundo-rolex/filarmonica-viena/';
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 active none-mobil">
                                        <a className="active" href="/rolex/mundo-rolex/filarmonica-viena/">Rolex y la Filarmónica de Viena</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
