...
const Grandslam: React.FC = () => {
    ...
    const currentUrl = (typeof window !== 'undefined' && window.location) ? window.location.href : 'https://glauser.myvtex.com/rolex/mundo-rolex/grand-slam-of-show-jumping/';
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 active none-mobil">
                                        <a className="active" href="https://glauser.myvtex.com/rolex/mundo-rolex/grand-slam-of-show-jumping/">Rolex Grand Slam of Show Jumping</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
