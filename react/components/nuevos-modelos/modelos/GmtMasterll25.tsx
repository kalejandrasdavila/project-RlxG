...
const ModGmtMasterII2025: React.FC = () => { // Tipado del componente funcional
    useInitScripts();

    // Obtener la URL actual dinámicamente para canonical y OG tags
    const currentUrl = typeof window !== 'undefined' ? window.location.href : 'https://devjhernandez--glauser.myvtex.com/rolex/nuevos-modelos-2025/gmt-master-ii/';
    const baseUrl = 'https://devjhernandez--glauser.myvtex.com'; // La URL base de tu sitio en producción

    return (
        // Si este componente (ModGmtMasterII2025) es el punto de entrada principal para una ruta o página
