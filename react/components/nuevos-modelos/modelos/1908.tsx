...
const Mod1980: React.FC = () => { // Tipado del componente funcional
    useInitScripts();

    // Obtener la URL actual dinámicamente para canonical y OG tags
    const currentUrl = typeof window !== 'undefined' ? window.location.href : 'https://www.glauser.com.co/rolex/nuevos-modelos-2025/1980/';
    const baseUrl = 'https://www.glauser.com.co'; // La URL base de tu sitio en producción

    return (
        // Si este componente (Mod1980) es el punto de entrada principal para una ruta o página
