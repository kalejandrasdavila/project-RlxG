...
const M1262310022: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel y oro Everose, m126231-0022 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel y oro Everose en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0022/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0022/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel y oro Everose, m126231-0022 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0022/" />
                <meta
                    name="twitter:title"
                    content="Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel y oro Everose, m126231-0022 - GLAUSER"
                />
                ...
                {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0022/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0022/",
                                "name": "Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel y oro Everose, m126231-0022 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel y oro Everose en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0022/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0022/"] }]
                            }
                        ]
                   `}
                ...
                {`
                        ...
                        "name": "Datejust 36",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel y oro Everose en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m126231-0022",
                        "mpn": "126231",
            ...
            <main id="rlx-html">
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0022/">m126231-0022
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="row-grid-fullw watch-model-titleimg">
                                ...
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light block block">
                                            Oyster, 36 mm, acero Oystersteel y oro Everose
                                        </span>
                                        <span className="body-20-light">m126231-0022</span>
                                    </h1>
                            ...
                            <div className="col-6-6-4 order-1-mob">
                                ...
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-gallery1-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-gallery1-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0022 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-gallery2-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-gallery2-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0022 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-gallery3-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-gallery3-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0022 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-gallery4-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-gallery4-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0022 reloj galeria"/>
                                    </picture>
                                    </div>
                                </div>
                ...
                <div className="rlx-container-content">
                    ...
                    <div className="lightbox-content">
                        ...
                        <img id="lightbox-image" src="" alt="m126231-0022 reloj galeria"/>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                            <div className="row-grid-6-12-7 pt-90-60 cuerpotextobeigebg">
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">126231</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Modelo caja</span>
                                            <span className="body-20-light">Oyster, 36 mm, acero Oystersteel y oro Everose</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-6-12-7 border-top-brown p-relative" style={{ marginTop: "30px" }}>
                                    <div className="p-absolutes">
                                        <a href="https://assets.rolex.com/api/brochure/es/datejust/m126231-0022.pdf" target="_blank" className="btn-primary-icon-rlx">
                            ...
                            <div className="col-6-6-5-3 order-1-mob"  style={{ display: "none" }}>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-cor-specs-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-cor-specs-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0022 especificaciones"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <p className="headline50 c-brown-text pb-20">Esfera de nácar</p>
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126231-0022-dial-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126231-0022-dial-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0022 esfera"/>
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">Bisel estriado</p>
                                <p className="body-20-light">El bisel estriado de Rolex es una marca de distinción. En un principio, el diseño estriado del bisel Oyster tenía una función específica: servía para atornillar el bisel a la caja garantizando la hermeticidad del reloj. Además, era idéntico al acanalado del fondo de la caja, atornillado a ésta por la misma razón, mediante herramientas específicas de Rolex. Con el tiempo, el estriado se convirtió en un elemento puramente estético, una auténtica característica distintiva de Rolex. En la actualidad, el estriado es una marca de distinción, en oro en este Datejust 36.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126231-0022-bezel-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126231-0022-bezel-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0022 bisel"/>
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126231-0022-material-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126231-0022-material-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0022 material"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            ...
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Datejust m126231-0022 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0022-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
