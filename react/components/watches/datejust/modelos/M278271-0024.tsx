...
const M2782710024: React.FC = () => {
    ...
    return (
        <>
            ...
            <Helmet>
                <title>Rolex Datejust 31 de Oyster, 31 mm, acero Oystersteel y oro Everose, m278271-0024 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Datejust 31 de Oyster, 31 mm, acero Oystersteel y oro Everose en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m278271-0024/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m278271-0024/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Datejust 31 de Oyster, 31 mm, acero Oystersteel y oro Everose, m278271-0024 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m278271-0024/" />
                <meta
                    name="twitter:title"
                    content="Rolex Datejust 31 de Oyster, 31 mm, acero Oystersteel y oro Everose, m278271-0024 - GLAUSER"
                />
                ...
                {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m278271-0024/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m278271-0024/",
                                "name": "Rolex Datejust 31 de Oyster, 31 mm, acero Oystersteel y oro Everose, m278271-0024 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Datejust 31 de Oyster, 31 mm, acero Oystersteel y oro Everose en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m278271-0024/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m278271-0024/"] }]
                            }
                        ]
                   `}
                ...
                {`
                        ...
                        "name": "Datejust 31",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Datejust 31 de Oyster, 31 mm, acero Oystersteel y oro Everose en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m278271-0024",
                        "mpn": "278271",
            ...
            <main id="rlx-html">
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m278271-0024/">m278271-0024
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="row-grid-fullw watch-model-titleimg">
                                ...
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light block block">
                                            Oyster, 31 mm, acero Oystersteel y oro Everose
                                        </span>
                                        <span className="body-20-light">m278271-0024</span>
                                    </h1>
                            ...
                            <div className="col-6-6-4 order-1-mob">
                                ...
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-gallery1-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-gallery1-landscape.webp" loading="lazy" alt="Rolex Datejust m278271-0024 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-gallery2-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-gallery2-landscape.webp" loading="lazy" alt="Rolex Datejust m278271-0024 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-gallery3-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-gallery3-landscape.webp" loading="lazy" alt="Rolex Datejust m278271-0024 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-gallery4-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-gallery4-landscape.webp" loading="lazy" alt="Rolex Datejust m278271-0024 reloj galeria"/>
                                    </picture>
                                    </div>
                                </div>
                ...
                <div className="rlx-container-content">
                    ...
                    <div className="lightbox-content">
                        ...
                        <img id="lightbox-image" src="" alt="m278271-0024 reloj galeria"/>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                            <div className="row-grid-6-12-7 pt-90-60 cuerpotextobeigebg">
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">278271</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Modelo caja</span>
                                            <span className="body-20-light">Oyster, 31 mm, acero Oystersteel y oro Everose</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Color «rosé» engastada de diamantes</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-6-12-7 border-top-brown p-relative" style={{ marginTop: "30px" }}>
                                    <div className="p-absolutes">
                                        <a href="https://assets.rolex.com/api/brochure/es/datejust/m278271-0024.pdf" target="_blank" className="btn-primary-icon-rlx">
                            ...
                            <div className="col-6-6-5-3 order-1-mob"  style={{ display: "none" }}>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-cor-specs-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-cor-specs-landscape.webp" loading="lazy" alt="Rolex Datejust m278271-0024 especificaciones"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                ...
                <section className="c-lightbeige-bg">
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m278271-0024-dial-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m278271-0024-dial-landscape.webp" loading="lazy" alt="Rolex Datejust m278271-0024 esfera"/>
                                    </picture>
                                </div>
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m278271-0024-bezel-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m278271-0024-bezel-landscape.webp" loading="lazy" alt="Rolex Datejust m278271-0024 bisel"/>
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m278271-0024-material-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m278271-0024-material-landscape.webp" loading="lazy" alt="Rolex Datejust m278271-0024 material"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            ...
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Datejust m278271-0024 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m278271-0024-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
