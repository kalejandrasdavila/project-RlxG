                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">El lacado ofrece una enorme libertad de elección de colores y confiere a la esfera una hermosa intensidad, así como un acabado liso. La tícnica de lacado consiste en depositar sucesivamente seis finas capas de laca sobre una placa base de latín. A continuaciín se aplica un barniz incoloro para aportar al color o al tono toda su profundidad y brillo. Una vez seco el barniz, se pule la superficie de la esfera para magnificar el color. A continuaciín la esfera se prepara para ser tampografiada y colocarle los indicadores.</p>
