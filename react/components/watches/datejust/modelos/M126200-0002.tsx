                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">
                                    ...
                                    función, estética y tícnica, diseñado para ser a la vez robusto y
                                    confortable. Estí equipado con un cierre Oysterclasp y cuenta con un
                                    címodo sistema de extensiín rípida Easylink, otra característica
                                    exclusiva de Rolex. Este ingenioso sistema de extensiín permite
                                    ajustar fícilmente la longitud del brazalete de aproximadamente 5 mm,
