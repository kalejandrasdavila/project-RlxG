...
const M126284rbr0011: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel, oro blanco y diamantes, m126284rbr-0011 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel, oro blanco y diamantes en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126284rbr-0011/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126284rbr-0011/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel, oro blanco y diamantes, m126284rbr-0011 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126284rbr-0011/" />
                <meta
                    name="twitter:title"
                    content="Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel, oro blanco y diamantes, m126284rbr-0011 - GLAUSER"
                />
                ...
                {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126284rbr-0011/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126284rbr-0011/",
                                "name": "Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel, oro blanco y diamantes, m126284rbr-0011 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel, oro blanco y diamantes en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126284rbr-0011/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126284rbr-0011/"] }]
                            }
                        ]
                   `}
                ...
                {`
                        ...
                        "name": "Datejust 36",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel, oro blanco y diamantes en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m126284rbr-0011",
                        "mpn": "126284RBR",
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126284rbr-0011/">m126284rbr-0011
                                        </a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div className="centered-content">
          <h1 className="mb-10 rolex-detail">
            ...
            <span className="body-20-light block block">
              Oyster, 36 mm, acero Oystersteel, oro blanco y diamantes
            </span>
            <span className="body-20-light">m126284rbr-0011</span>
          </h1>
      ...
      <div className="col-6-6-4 order-1-mob">
                        <div className="swiper swiper-container-mobile">
                          <div className="swiper-wrapper">
                            ...
                            <div className="swiper-slide">
                              <picture className="rlx-pbanner-top p-relative">
                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-gallery1-portrait.webp" />
                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-gallery1-landscape.webp" loading="lazy" alt="Rolex Datejust m126284rbr-0011 reloj galeria"/>
                              </picture>
                            </div>
                            <div className="swiper-slide">
                              <picture className="rlx-pbanner-top p-relative">
                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-gallery2-portrait.webp" />
                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-gallery2-landscape.webp" loading="lazy" alt="Rolex Datejust m126284rbr-0011 reloj galeria"/>
                              </picture>
                            </div>
                            <div className="swiper-slide">
                              <picture className="rlx-pbanner-top p-relative">
                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-gallery3-portrait.webp" />
                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-gallery3-landscape.webp" loading="lazy" alt="Rolex Datejust m126284rbr-0011 reloj galeria"/>
                              </picture>
                            </div>
                            <div className="swiper-slide">
                              <picture className="rlx-pbanner-top p-relative">
                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-gallery4-portrait.webp" />
                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-gallery4-landscape.webp" loading="lazy" alt="Rolex Datejust m126284rbr-0011 reloj galeria"/>
                              </picture>
                            </div>
                          </div>
          ...
          <div className="rlx-container-content">
            ...
            <div id="lightbox" className="lightbox">
              ...
              <div className="lightbox-content">
                  ...
                  <img id="lightbox-image" src="" alt="m126284rbr-0011 reloj galeria"/>
            ...
            <div className="rlx-container-content">
                <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                    <div className="row-grid-6-12-7 pt-90-60 cuerpotextobeigebg">
                        <div className="col-3-5-3-1">
                            <ul className="list-especification-model-rlx">
                                <li>
                                    ...
                                    <span className="body-20-light">126284RBR</span>
                                </li>
                                <li>
                                    <span className="body-20-bold block">Modelo caja</span>
                                    <span className="body-20-light">Oyster, 36 mm, acero Oystersteel, oro blanco y diamantes</span>
                                </li>
                                <li>
                        ...
                        <div className="col-3-5-3-3">
                            <ul className="list-especification-model-rlx ">
                                <li>
                                    ...
                                    <span className="body-20-light">Nácar blanco engastada de diamantes</span>
                                </li>
                                <li>
                        ...
                        <div className="col-6-12-7 border-top-brown p-relative" style={{ marginTop: "30px" }}>
                            <div className="p-absolutes">
                                <a href="https://assets.rolex.com/api/brochure/es/datejust/m126284rbr-0011.pdf" target="_blank" className="btn-primary-icon-rlx">
                    ...
                    <div className="col-6-6-5-3 order-1-mob"  style={{ display: "none" }}>
                        <picture className="rlx-pbanner-top p-relative">
                            <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-cor-specs-portrait.webp"/>
                            <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-cor-specs-landscape.webp" loading="lazy" alt="Rolex Datejust m126284rbr-0011 especificaciones"/>
                        </picture>
                    </div>
                </div>
            </div>
            ...
            <div className="rlx-container-content py-90-60">
                <div className="row-grid-fullw cuerpotexto">
                    <div className="col-text-center">
                        ...
                        <p className="body-20-light">Esta esfera presenta Diamantes con engaste chatón en oro de 18 quilates. El nácar, por su naturaleza, se presenta como un material misterioso y sorprendente. Según su origen, puede ser rosa, blanco, negro o amarillo. Su color, intensidad y estructura varían dependiendo de la parte de la concha de la cual ha sido extraído. En Rolex, el nácar nunca se colorea de forma artificial. Sencillamente destacamos su belleza natural y preservamos sus colores naturales gracias a un savoir-faire particular y una gran habilidad. Las esferas de nácar son piezas únicas, por lo que nunca encontrará una igual a la suya en otra muñeca.</p>
                        <div className="pb-45-40">
                            <picture className="rlx-pbanner-top p-relative">
                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126284rbr-0011-dial-portrait.webp"/>
                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126284rbr-0011-dial-landscape.webp" loading="lazy" alt="Rolex Datejust m126284rbr-0011 esfera"/>
                            </picture>
                        </div>
                        <p className="headline50 c-brown-text pb-20">Bisel engastado de diamantes</p>
                        <p className="body-20-light">Los engastadores, al igual que los escultores, modelan los metales preciosos para preparar el espacio donde alojarán perfectamente cada piedra preciosa de forma manual. Con el arte y savoir-faire de los joyeros, cada piedra se alinea meticulosamente hasta engastarla de forma segura en el oro o en el platino. Además de la calidad intrínseca de las piedras, otros factores contribuyen a la belleza del engaste de piedras de Rolex: la alineación precisa del tamaño de las piedras, su orientación y posición, la regularidad, la solidez y las proporciones del engaste, así como el acabado del trabajo en metal. Una combinación mágica de luces que embellece el reloj y hechiza a quien lo lleva.</p>
                        <div className="pb-45-40">
                            <picture className="rlx-pbanner-top p-relative">
                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126284rbr-0011-bezel-portrait.webp"/>
                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126284rbr-0011-bezel-landscape.webp" loading="lazy" alt="Rolex Datejust m126284rbr-0011 bisel"/>
                            </picture>
                        </div>
                ...
                <div className="row-grid-fullw cuerpotexto">
                    <div className="col-text-center">
                        <picture className="rlx-pbanner-top p-relative">
                            <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126284rbr-0011-material-portrait.webp"/>
                            <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126284rbr-0011-material-landscape.webp" loading="lazy" alt="Rolex Datejust m126284rbr-0011 material"/>
                        </picture>
                    </div>
                </div>
            </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto dispmodel">
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-presentation-box-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126284rbr-0011-presentation-box-landscape.webp" loading="lazy" alt="Rolex Datejust m126284rbr-0011 caja presentación" />
                                    </picture>
                                </div>
                            </div>
                        </div>
