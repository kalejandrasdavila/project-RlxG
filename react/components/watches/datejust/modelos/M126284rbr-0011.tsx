                ...
                <div className="col-3-5-3-3">
                  <ul className="list-especification-model-rlx ">
                    <li>
                      ...
                      <span className="body-20-light">Nícar blanco engastada de diamantes</span>
                    </li>
                    <li>
          ...
          <div className="rlx-container-content py-90-60">
            <div className="row-grid-fullw cuerpotexto">
              <div className="col-text-center">
                <p className="headline50 c-brown-text pb-20">Esfera nícar</p>
                <p className="body-20-light">Esta esfera presenta Diamantes con engaste chatín en oro de 18 quilates. El nícar, por su naturaleza, se presenta como un material misterioso y sorprendente. Segín su origen, puede ser rosa, blanco, negro o amarillo. Su color, intensidad y estructura varían dependiendo de la parte de la concha de la cual ha sido extraído. En Rolex, el nícar nunca se colorea de forma artificial. Sencillamente destacamos su belleza natural y preservamos sus colores naturales gracias a un savoir-faire particular y una gran habilidad. Las esferas de nícar son piezas únicas, por lo que nunca encontrarí una igual a la suya en otra muñeca.</p>
