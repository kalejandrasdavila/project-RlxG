...
const M1262310018: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel y oro Everose, m126231-0018 - GLAUSER</title>
                <meta
                    name="description"
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0018/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0018/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel y oro Everose, m126231-0018 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0018/" />
                <meta
                    name="twitter:title"
                    content="Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel y oro Everose, m126231-0018 - GLAUSER"
                />
                ...
                {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0018/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0018/",
                                "name": "Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel y oro Everose, m126231-0018 - GLAUSER",
                                ...
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0018/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0018/"] }]
                            }
                        ]
                   `}
                ...
                {`
                        ...
                        "name": "Datejust 36",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Datejust 36 de Oyster, 36 mm, acero Oystersteel y oro Everose en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m126231-0018",
                        "mpn": "126231",
            ...
            <main id="rlx-html">
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126231-0018/">m126231-0018
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="row-grid-fullw watch-model-titleimg">
                            <div className="col-6-4-3 pb-90-60">
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light">m126231-0018</span>
                                    </h1>
                            ...
                            <div className="col-6-6-4 order-1-mob">
                                ...
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-gallery1-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-gallery1-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0018 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-gallery2-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-gallery2-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0018 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-gallery3-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-gallery3-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0018 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-gallery4-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-gallery4-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0018 reloj galeria"/>
                                    </picture>
                                    </div>
                                </div>
                ...
                <div className="rlx-container-content">
                    ...
                    <div className="lightbox-content">
                        ...
                        <img id="lightbox-image" src="" alt="m126231-0018 reloj galeria"/>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                            <div className="row-grid-6-12-7 pt-90-60 cuerpotextobeigebg">
                                ...
                                <div className="col-6-12-7 border-top-brown p-relative" style={{ marginTop: "30px" }}>
                                    <div className="p-absolutes">
                                        <a href="https://assets.rolex.com/api/brochure/es/datejust/m126231-0018.pdf" target="_blank" className="btn-primary-icon-rlx">
                            ...
                            <div className="col-6-6-5-3 order-1-mob"  style={{ display: "none" }}>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-cor-specs-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-cor-specs-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0018 especificaciones"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">El lacado ofrece una enorme libertad de elección de colores y confiere a la esfera una hermosa intensidad, así como un acabado liso. La técnica de lacado consiste en depositar sucesivamente seis finas capas de laca sobre una placa base de latón. A continuación se aplica un barniz incoloro para aportar al color o al tono toda su profundidad y brillo. Una vez seco el barniz, se pule la superficie de la esfera para magnificar el color. A continuación la esfera se prepara para ser tampografiada y colocarle los indicadores.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126231-0018-dial-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126231-0018-dial-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0018 esfera"/>
                                    </picture>
                                </div>
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126231-0018-bezel-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126231-0018-bezel-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0018 bisel"/>
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126231-0018-material-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126231-0018-material-landscape.webp" loading="lazy" alt="Rolex Datejust m126231-0018 material"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            ...
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Datejust m126231-0018 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126231-0018-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
