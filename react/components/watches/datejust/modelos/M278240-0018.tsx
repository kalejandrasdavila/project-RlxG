                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">El diseño, desarrollo y producciín de los brazaletes y cierres Rolex, así como las estrictas pruebas que deben superar, requieren la tecnología más avanzada. Al igual que sucede con los demás componentes del reloj, los controles estéticos realizados por nuestros expertos garantizan una belleza impecable. El Jubilee, un brazalete fluido y confortable de eslabones de cinco elementos de metal, se creí específicamente para el lanzamiento del modelo Oyster Perpetual Datejust en 1945.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
