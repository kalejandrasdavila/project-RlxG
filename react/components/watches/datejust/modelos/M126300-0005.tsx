...
const M1263000005: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Datejust 41 de Oyster, 41 mm, acero Oystersteel, m126300-0005 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Datejust 41 de Oyster, 41 mm, acero Oystersteel en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126300-0005/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126300-0005/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Datejust 41 de Oyster, 41 mm, acero Oystersteel, m126300-0005 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126300-0005/" />
                <meta
                    name="twitter:title"
                    content="Rolex Datejust 41 de Oyster, 41 mm, acero Oystersteel, m126300-0005 - GLAUSER"
                />
                ...
                {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126300-0005/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126300-0005/",
                                "name": "Rolex Datejust 41 de Oyster, 41 mm, acero Oystersteel, m126300-0005 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Datejust 41 de Oyster, 41 mm, acero Oystersteel en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126300-0005/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126300-0005/"] }]
                            }
                        ]
                   `}
                ...
                {`
                        ...
                        "name": "Datejust 41",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Datejust 41 de Oyster, 41 mm, acero Oystersteel en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m126300-0005",
                        "mpn": "126300",
            ...
            <main id="rlx-html">
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/datejust/m126300-0005/">m126300-0005
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="row-grid-fullw watch-model-titleimg">
                            <div className="col-6-4-3 pb-90-60">
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light">m126300-0005</span>
                                    </h1>
                            ...
                            <div className="col-6-6-4 order-1-mob">
                                ...
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-gallery1-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-gallery1-landscape.webp" loading="lazy" alt="Rolex Datejust m126300-0005 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-gallery2-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-gallery2-landscape.webp" loading="lazy" alt="Rolex Datejust m126300-0005 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-gallery3-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-gallery3-landscape.webp" loading="lazy" alt="Rolex Datejust m126300-0005 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-gallery4-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-gallery4-landscape.webp" loading="lazy" alt="Rolex Datejust m126300-0005 reloj galeria"/>
                                    </picture>
                                    </div>
                                </div>
                ...
                <div className="rlx-container-content">
                    ...
                    <div className="lightbox-content">
                        ...
                        <img id="lightbox-image" src="" alt="m126300-0005 reloj galeria"/>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                            <div className="row-grid-6-12-7 pt-90-60 cuerpotextobeigebg">
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">126300</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Modelo caja</span>
                                            <span className="body-20-light">Oyster, 41 mm, acero Oystersteel</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-6-12-7 border-top-brown p-relative" style={{ marginTop: "30px" }}>
                                    <div className="p-absolutes">
                                        <a href="https://assets.rolex.com/api/brochure/es/datejust/m126300-0005.pdf" target="_blank" className="btn-primary-icon-rlx">
                            ...
                            <div className="col-6-6-5-3 order-1-mob"  style={{ display: "none" }}>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-cor-specs-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-cor-specs-landscape.webp" loading="lazy" alt="Rolex Datejust m126300-0005 especificaciones"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                ...
                <section className="c-lightbeige-bg">
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126300-0005-dial-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126300-0005-dial-landscape.webp" loading="lazy" alt="Rolex Datejust m126300-0005 esfera"/>
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">El brazalete Oyster</p>
                                <p className="body-20-light">El brazalete Oyster es fruto de una alquimia perfecta entre forma y función, estética y técnica, diseñado para ser a la vez robusto y confortable. Está equipado con un cierre Oysterclasp y cuenta con un cómodo sistema de extensión rápida Easylink, otra característica exclusiva de Rolex. Este ingenioso sistema de extensión permite ajustar fácilmente la longitud del brazalete de aproximadamente 5 mm, con el fin de ofrecer una mayor comodidad en cualquier circunstancia.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/anim-bracelet-material-portrait-126300-72610.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/anim-bracelet-material-portrait-126300-72610.webp" loading="lazy" alt="Rolex Datejust m126300-0005 bisel"/>
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126300-0005-material-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126300-0005-material-landscape.webp" loading="lazy" alt="Rolex Datejust m126300-0005 material"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            ...
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Datejust m126300-0005 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126300-0005-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
