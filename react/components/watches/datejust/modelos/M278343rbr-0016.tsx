                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">Esta esfera presenta un gran VI engastado de 11 diamantes. El acabado tipo sol crea delicados reflejos de luz en muchas esferas de la colecciín Oyster Perpetual. Se obtiene utilizando tícnicas magistrales de cepillado que crean surcos que salen del centro de la esfera. La luz se difunde constantemente a lo largo de cada grabado, creando un sutil brillo característico que se mueve segín la posición de la muñeca. Una vez completado el acabado tipo sol, el color de la esfera se aplica mediante PVD (Physical Vapour Deposition) o galvanoplastia. Una ligera capa de barniz le da a la esfera su aspecto final.</p>
