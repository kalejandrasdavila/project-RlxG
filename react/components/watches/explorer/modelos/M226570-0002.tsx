...
const M2265700002: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Explorer II de Oyster, 42 mm, acero Oystersteel, m226570-0002 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Explorer II de Oyster, 42 mm, acero Oystersteel en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/explorer/m226570-0002/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/explorer/m226570-0002/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Explorer II de Oyster, 42 mm, acero Oystersteel, m226570-0002 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/explorer/m226570-0002/" />
                <meta
                    name="twitter:title"
                    content="Rolex Explorer II de Oyster, 42 mm, acero Oystersteel, m226570-0002 - GLAUSER"
                />
                ...
                <script type="application/ld+json" dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/explorer/m226570-0002/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/explorer/m226570-0002/",
                                "name": "Rolex Explorer II de Oyster, 42 mm, acero Oystersteel, m226570-0002 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Explorer II de Oyster, 42 mm, acero Oystersteel en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/explorer/m226570-0002/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/explorer/m226570-0002/"] }]
                            }
                        ]
                    })
                }} />
                <script type="application/ld+json" dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "name": "Explorer II",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Explorer II de Oyster, 42 mm, acero Oystersteel en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m226570-0002",
                        "mpn": "226570",
                ...
                <script type="application/ld+json" dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "itemListElement": [{
                            ...
                            "position": 3,
                            "name": "Explorer",
                            "item": "https://devjhernandez--glauser.myvtex.com/rolex/watches/explorer/"
                        }, {
                            "@type": "ListItem",
                            "position": 4,
                            "name": "m226570-0002"
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14">
                                        <a href="https://devjhernandez--glauser.myvtex.com/rolex/watches/explorer/">
                                            Explorer
                                        </a>
                                    </li>
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/explorer/m226570-0002/">m226570-0002
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light block block">
                                            Oyster, 42 mm, acero Oystersteel
                                        </span>
                                        <span className="body-20-light">m226570-0002</span>
                                    </h1>
                            ...
                            <div className="col-6-6-4 order-1-mob">
                                <div className="swiper swiper-container-mobile">
                                    <div className="swiper-wrapper">
                                        ...
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery1-landscape.webp" loading="lazy" alt="Rolex Explorer m226570-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery2-landscape.webp" loading="lazy" alt="Rolex Explorer m226570-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery3-landscape.webp" loading="lazy" alt="Rolex Explorer m226570-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery4-landscape.webp" loading="lazy" alt="Rolex Explorer m226570-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw galeria-models">
                            <div className="span-3-1">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        ...
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery1-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Explorer m226570-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery1-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-2">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery2-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Explorer m226570-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery2-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-3">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery3-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Explorer m226570-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery3-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-4">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery4-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Explorer m226570-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-gallery4-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        <div className="lightbox" id="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img alt="m226570-0002 reloj galeria" id="lightbox-image" src="" />
                        ...
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">226570</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">Fijo, graduado 24 horas</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div
                                    ...
                                    <div className="p-absolutes">
                                        <a
                                            ...
                                            href="https://assets.rolex.com/api/brochure/es/explorer/m226570-0002.pdf"
                                            target="_blank">
                                            <svg
                            ...
                            <div
                                ...
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-cor-specs-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Explorer m226570-0002 especificaciones"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-cor-specs-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <p className="headline50 c-brown-text pb-20">Bisel 24 horas</p>
                                <p className="body-20-light">
                                    Estí equipado con una visualización adicional de 24 horas; una aguja
                                    dedicada da vuelta a la esfera en 24 horas en lugar de las usuales 12,
                                    apuntando a un bisel fijo con graduaciones de 24 horas. Esta función
                                    permite a quienes lo llevan distinguir las horas del día de las de la
                                    noche, una característica que resulta esencial para quienes se
                                    adentran en medios ambientes donde reina la oscuridad ícomo las
                                    profundidades de las cuevas o donde el sol nunca se poneí como en las
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m226570-0002-bezel-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Explorer m226570-0002 bisel"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m226570-0002-bezel-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">Esfera negra</p>
                                <p className="body-20-light">
                                    El ExploreríII está equipado con la visualización de la fecha, una aguja adicional 24íhoras y un bisel fijo con graduaciones 24íhoras que permite distinguir las horas del día de las de la noche. Se convirtió en el reloj de espeleílogos, vulcanílogos y exploradores de las regionesípolares. Sus agujas e índices presentan una visualización Chromalight de alta legibilidad con luminiscencia azul de larga duración.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m226570-0002-dial-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Explorer m226570-0002 esfera"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m226570-0002-dial-landscape.webp"
                                        />
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m226570-0002-material-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Explorer m226570-0002 material"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m226570-0002-material-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Explorer m226570-0002 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m226570-0002-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
                ...
                <section className="c-lightbeige-bg">
                    <div className="rlx-container-content py-90-60">
                            ...
                            <div className="col-6-12">
                                <a href="https://devjhernandez--glauser.myvtex.com/rolex/watches/explorer/">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-banners/rolex-collection-banner-explorer-m226570-0001-portrait.webp"
                                        />
                                        <img
                                            alt="Colecciín Rolex Explorer"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-banners/rolex-collection-banner-explorer-m226570-0001-landscape.webp"
                                        />
                                    </picture>
                                </a>
                            </div>
                        ...
                        <div className="row-grid-fullw component-2-col">
                            <div className="col-lg-2-6">
                                <div className="pt-10">
                                    <p className="fixed-16 c-brown-text">Rolex Explorer</p>
                                    <p className="headline36 c-brown-text">La grandeza de la aventura</p>
                                    <a
                                        className="btn-label-icon-rlx"
                                        href="https://devjhernandez--glauser.myvtex.com/rolex/watches/explorer/">
                                        Mís información
                                        <svg
