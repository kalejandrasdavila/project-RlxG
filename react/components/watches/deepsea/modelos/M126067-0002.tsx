...
const M1260670002: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Deepsea Challenge de Oyster, 50 mm, titanio RLX, m126067-0002 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Deepsea Challenge de Oyster, 50 mm, titanio RLX en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m126067-0002/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m126067-0002/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Deepsea Challenge de Oyster, 50 mm, titanio RLX, m126067-0002 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m126067-0002/" />
                <meta
                    name="twitter:title"
                    content="Rolex Deepsea Challenge de Oyster, 50 mm, titanio RLX, m126067-0002 - GLAUSER"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m126067-0002/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m126067-0002/",
                                "name": "Rolex Deepsea Challenge de Oyster, 50 mm, titanio RLX, m126067-0002 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Deepsea Challenge de Oyster, 50 mm, titanio RLX en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m126067-0002/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m126067-0002/"] }]
                            }
                        ]
                   `}
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Deepsea Challenge de Oyster, 50 mm, titanio RLX en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m126067-0002",
                        "mpn": "126067",
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "itemListElement": [{
                            ...
                            "position": 3,
                            "name": "Deepsea",
                            "item": "https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/"
                        }, {
                            "@type": "ListItem",
                            "position": 4,
                            "name": "m126067-0002"
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14">
                                        <a href="https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/">
                                            Deepsea
                                        </a>
                                    </li>
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m126067-0002/">m126067-0002
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light block block">
                                            Oyster, 50 mm, titanio RLX
                                        </span>
                                        <span className="body-20-light">m126067-0002</span>
                                    </h1>
                            ...
                            <div className="col-6-6-4 order-1-mob">
                                <div className="swiper swiper-container-mobile">
                                    <div className="swiper-wrapper">
                                        ...
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery1-landscape.webp" loading="lazy" alt="Rolex Deepsea m126067-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery2-landscape.webp" loading="lazy" alt="Rolex Deepsea m126067-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery3-landscape.webp" loading="lazy" alt="Rolex Deepsea m126067-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery4-landscape.webp" loading="lazy" alt="Rolex Deepsea m126067-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw galeria-models">
                            <div className="span-3-1">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        ...
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery1-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Deepsea m126067-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery1-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-2">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery2-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Deepsea m126067-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery2-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-3">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery3-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Deepsea m126067-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery3-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-4">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery4-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Deepsea m126067-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-gallery4-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        <div className="lightbox" id="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img alt="m126067-0002 reloj galeria" id="lightbox-image" src="" />
                        ...
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">126067</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Modelo caja</span>
                                            <span className="body-20-light">Oyster, 50 mm, titanio RLX</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Hermetecidad</span>
                                            <span className="body-20-light">
                                                Herm�tico hasta 11 000 metros / 36 090 pies, v�lvula de helio
                                            </span>
                                        </li>
                                        <li>
                                            ...
                                            <span className="body-20-light">
                                                ...
                                                cer�mica resistente a las rayaduras, n�meros y graduaciones
                                ...
                                <div className="col-3-5-3-2">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">50 mm</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">3230, Manufactura Rolex</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div
                                    ...
                                    <div className="p-absolutes">
                                        <a
                                            ...
                                            href="https://assets.rolex.com/api/brochure/es/deepsea/m126067-0002.pdf"
                                            target="_blank">
                                            <svg
                            ...
                            <div
                                ...
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-cor-specs-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Deepsea m126067-0002 especificaciones"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-cor-specs-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <p className="headline50 c-brown-text pb-20">
                                    Bisel de cer�mica y visualizaci�n luminiscente
                                </p>
                                <p className="body-20-light">
                                    El bisel giratorio unidireccional graduado 60�minutos del Deepsea
                                    Challenge permite visualizar los tiempos de inmersi�n y descompresi�n
                                    con total seguridad. Est� equipado con un disco de bisel Cerachrom
                                    negro patentado y fabricado por Rolex en una cer�mica pr�cticamente
                                    imposible de rayar o alterar por los rayos ultravioleta. La graduaci�n
                                    se obtiene por PVD (Physical Vapour Deposition) de una fina capa de
                                    platino. La esfera aloja grandes �ndices y agujas Chromalight,
                                    recubiertas de un material luminiscente de larga duraci�n, que emite
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126067-0002-bezel-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Deepsea m126067-0002 bisel"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126067-0002-bezel-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">Esfera negro intenso</p>
                                <p className="body-20-light">
                                    La visualizaci�n luminiscente Chromalight de la esfera constituye una
                                    innovaci�n que mejora la visibilidad en entornos oscuros, una funci�n
                                    especial para los submarinistas. Los �ndices de formas simples
                                    �tri�ngulos, c�rculos, rect�ngulos� y las anchas agujas de horas y
                                    minutos facilitan la lectura y previenen cualquier riesgo de confusi�n
                                    bajo el agua.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126067-0002-dial-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Deepsea m126067-0002 esfera"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126067-0002-dial-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                <div className="pb-90-60">
                                    <p className="headline50 c-brown-text pb-20">Titanio RLX</p>
                                    <p className="body-20-light">
                                        El titanio�RLX, aleaci�n de titanio grado�5 seleccionada por Rolex,
                                        se distingue por su ligereza y sus cualidades de resistencia a las
                                        deformaciones y la corrosi�n. Insensible a la presi�n reinante en
                                        los abismos, el reloj experimental que descendi� con James�Cameron a
                                        la fosa de las Marianas, realizado en acero�904L, planteaba un
                                        problema de portabilidad debido a su peso. El recurso del
                                        titanio�RLX para la fabricaci�n de la caja y el brazalete del
                                        Deepsea Challenge permiti� aligerar el peso del reloj, que se redujo
                                        en un 30�% con respecto a la pieza experimental de James�Cameron.
                                        Luce adem�s un satinado especialmente marcado en el conjunto de la
                                        caja �a excepci�n de los protectores de la corona� y el brazalete.
                                        Con el fin de resaltar el contorno de las asas, los cantos
                                        superiores se han achaflanado y pulido.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126067-0002-material-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Deepsea m126067-0002 material"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126067-0002-material-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Deepsea m126067-0002 caja presentaci�n"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126067-0002-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
                ...
                <section className="c-lightbeige-bg">
                    <div className="rlx-container-content py-90-60">
                            ...
                            <div className="col-6-12">
                                <a href="https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-banners/rolex-collection-banner-rolex-deepsea-m136668lb-0001-portrait.webp"
                                        />
                                        <img
                                            alt="Colecci�n Rolex Deepsea"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-banners/rolex-collection-banner-rolex-deepsea-m136668lb-0001-landscape.webp"
                                        />
                                    </picture>
                                </a>
                            </div>
                        ...
                        <div className="row-grid-fullw component-2-col">
                            <div className="col-lg-2-6">
                                <div className="pt-10">
                                    <p className="fixed-16 c-brown-text">Rolex Deepsea</p>
                                    <p className="headline36 c-brown-text">
                                        Relojes de submarinismo extremos
                                    </p>
                                    <a
                                        className="btn-label-icon-rlx"
                                        href="https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/">
                                        M�s informaci�n
                                        <svg
