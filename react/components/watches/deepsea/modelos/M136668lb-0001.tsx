...
const M136668lb0001: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Deepsea de Oyster, 44 mm, oro amarillo, m136668lb-0001 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Deepsea de Oyster, 44 mm, oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m136668lb-0001/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m136668lb-0001/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Deepsea de Oyster, 44 mm, oro amarillo, m136668lb-0001 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m136668lb-0001/" />
                <meta
                    name="twitter:title"
                    content="Rolex Deepsea de Oyster, 44 mm, oro amarillo, m136668lb-0001 - GLAUSER"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m136668lb-0001/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m136668lb-0001/",
                                "name": "Rolex Deepsea de Oyster, 44 mm, oro amarillo, m136668lb-0001 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Deepsea de Oyster, 44 mm, oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m136668lb-0001/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m136668lb-0001/"] }]
                            }
                        ]
                   `}
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "name": "Rolex Deepsea",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Deepsea de Oyster, 44 mm, oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m136668lb-0001",
                        "mpn": "136668LB",
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/deepsea/m136668lb-0001/">m126067-0001
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light block block">
                                            Oyster, 44 mm, oro amarillo
                                        </span>
                                        <span className="body-20-light">m136668lb-0001</span>
                                    </h1>
                            ...
                            <div className="col-6-6-4 order-1-mob">
                                <div className="swiper swiper-container-mobile">
                                    <div className="swiper-wrapper">
                                        ...
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery1-landscape.webp" loading="lazy" alt="Rolex Deepsea m136668lb-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery2-landscape.webp" loading="lazy" alt="Rolex Deepsea m136668lb-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery3-landscape.webp" loading="lazy" alt="Rolex Deepsea m136668lb-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery4-landscape.webp" loading="lazy" alt="Rolex Deepsea m136668lb-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw galeria-models">
                            <div className="span-3-1">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        ...
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery1-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Deepsea m136668lb-0001 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery1-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-2">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery2-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Deepsea m136668lb-0001 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery2-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-3">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery3-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Deepsea m136668lb-0001 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery3-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-4">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery4-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Deepsea m136668lb-0001 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-gallery4-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        <div className="lightbox" id="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img alt="m136668lb-0001 reloj galeria" id="lightbox-image" src="" />
                        ...
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">136668LB</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Modelo caja</span>
                                            <span className="body-20-light">Oyster, 44 mm, oro amarillo</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Hermetecidad</span>
                                            <span className="body-20-light">
                                                Herm�tico hasta 3900 metros/ 12800 pies, v�lvula de helio
                                            </span>
                                        </li>
                                        <li>
                                            ...
                                            <span className="body-20-light">
                                                ...
                                                cer�mica azul resistente a las rayaduras, n�meros y graduaciones
                                                recubiertos en oro
                                            </span>
                                        </li>
                                    </ul>
                                ...
                                <div className="col-3-5-3-2">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">44 mm</span>
                                        </li>
                                        <li>
                                ...
                                <div
                                    ...
                                    <div className="p-absolutes">
                                        <a
                                            ...
                                            href="https://assets.rolex.com/api/brochure/es/deepsea/m136668lb-0001.pdf"
                                            target="_blank">
                                            <svg
                            ...
                            <div
                                ...
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-cor-specs-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Deepsea m136668lb-0001 especificaciones"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-cor-specs-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light pb-30">
                                    El bisel giratorio unidireccional graduado 60 minutos del Rolex
                                    Deepsea permite visualizar los tiempos de inmersi�n y descompresi�n
                                    con total seguridad. El �cero� de la graduaci�n, marcado con un
                                    tri�ngulo, resulta visible en la oscuridad gracias a un chat�n
                                    encajado en la carrura que contiene un material luminiscente de larga
                                    duraci�n que emite un color azul. La graduaci�n del bisel se obtiene
                                    por PVD (Physical Vapour Deposition, dep�sito f�sico en fase vapor) de
                                    una fina capa de oro.
                                </p>
                                <p className="body-20-light">
                                    La combinaci�n de azules de la anilla de compresi�n, la esfera y el
                                    disco de bisel Cerachrom imita un sutil muestrario de colores
                                    oce�nicos, iluminado por el oro amarillo de 18 quilates de la caja y
                                    del brazalete Oyster.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m136668lb-0001-bezel-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Deepsea m136668lb-0001 bisel"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m136668lb-0001-bezel-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">Esfera azul</p>
                                <p className="body-20-light pb-30">
                                    En la esfera lacada azul figura la inscripci�n �DEEPSEA� en amarillo
                                    empolvado. La esfera aloja grandes �ndices y agujas Chromalight,
                                ...
                                <p className="body-20-light">
                                    Los �ndices con formas geom�tricas elementales �tri�ngulo, c�rculo y
                                    rect�ngulo� y las agujas, claramente diferenciadas por su tama�o y su
                                    forma, est�n rellenos o cubiertos de un material luminiscente de larga
                                    duraci�n (color de emisi�n azul) que permanece hasta el doble de
                                    tiempo que los materiales fosforescentes cl�sicos.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m136668lb-0001-dial-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Deepsea m136668lb-0001 esfera"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m136668lb-0001-dial-landscape.webp"
                                        />
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m136668lb-0001-material-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Deepsea m136668lb-0001 material"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m136668lb-0001-material-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Deepsea m136668lb-0001 caja presentaci�n"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m136668lb-0001-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
