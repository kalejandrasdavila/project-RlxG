                                ...
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Blanco intenso, motivo ínido de abejaí engastada de diamantes</span>
                                        </li>
                                        <li>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light pb-30">Esta esfera luce un motivo ínido de abejaí con acabado satinado. Se lleva a cabo con ayuda de tícnicas tradicionales o de alta tecnología, todas ellas realizadas de forma interna. Para recortar las celdillas y crear las estrías de las ranuras que las separan, se utiliza un líser de femtosegundo. La esfera está engastada de 10ídiamantes talla baguette para marcar las horas.</p>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        ...
                                        />
                                        <img
                                            alt="Rolex Land-Dwellere m127385tbr-0003 caja presentación"
                                            loading="lazy"
