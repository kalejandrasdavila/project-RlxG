...
const M127286TBR0001: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Land-Dweller 36 de Oyster, 36 mm, platino y diamantes, m127286tbr-0001 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Land-Dweller 36 de Oyster, 36 mm, platino y diamantes en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/land-dweller/m127286tbr-0001/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/land-dweller/m127286tbr-0001/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Land-Dweller 36 de Oyster, 36 mm, platino y diamantes, m127286tbr-0001 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/land-dweller/m127286tbr-0001/" />
                <meta
                    name="twitter:title"
                    content="Rolex Land-Dweller 36 de Oyster, 36 mm, platino y diamantes, m127286tbr-0001 - GLAUSER"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/land-dweller/m127286tbr-0001/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/land-dweller/m127286tbr-0001/",
                                "name": "Rolex Land-Dweller 36 de Oyster, 36 mm, platino y diamantes, m127286tbr-0001 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Land-Dweller 36 de Oyster, 36 mm, platino y diamantes en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/land-dweller/m127286tbr-0001/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/land-dweller/m127286tbr-0001/"] }]
                            }
                        ]
                   `}
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Land-Dweller 36 de Oyster, 36 mm, platino y diamantes en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m127286tbr-0001",
                        "mpn": "127286TBR",
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/land-dweller/m127286tbr-0001/">m127286tbr-0001
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="col-6-4-3 pb-90-60">
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="headline50 c-brown-text block mb-10">Land-Dweller 36</span>
                                        <span className="body-20-light block block">
                                            Oyster, 36 mm, platino y diamantes
                                        </span>
                                        <span className="body-20-light">m127286tbr-0001</span>
                                    </h1>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="swiper-slider">
                                                <picture className="rlx-pbanner-top p-relative">
                                                    ...
                                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-drp-upright-bba-with-shadow-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127286tbr-0001 reloj" />
                                                </picture>
                                            </div>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-gallery1-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127286tbr-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-gallery2-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127286tbr-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-gallery3-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127286tbr-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-gallery4-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127286tbr-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        ...
                        <div id="lightbox" className="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img id="lightbox-image" src="" alt="m127286tbr-0001 reloj galeria" />
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">127286TBR</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Modelo caja</span>
                                            <span className="body-20-light">Oyster, 36 mm, platino y diamantes</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-3-5-3-2">
                                    <ul className="list-especification-model-rlx ">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">Flat Jubilee (5 elementos), eslabones macizos</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">7135, Manufactura Rolex</span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Azul glaciar, motivo �nido de abeja� engastada de diamantes</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">Cron�metro superlativo (COSC + certificaci�n Rolex tras el encajado)</span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-6-12-7 border-top-brown p-relative" style={{ marginTop: "30px" }}>
                                    <div className="p-absolutes">
                                        <a href="https://assets.rolex.com/api/brochure/es/land-dweller/m127286tbr-0001.pdf" target="_blank" className="btn-primary-icon-rlx">
                            ...
                            <div className="col-6-6-5-3 order-1-mob" style={{ display: "none" }}>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-cor-specs-portrait.webp" />
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-cor-specs-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127286tbr-0001 especificaciones" />
                                </picture>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light pb-30">Esta esfera azul glaciar, un color reservado a los relojes elaborados en platino, luce un motivo �nido de abeja� con acabado tipo sol. Se lleva a cabo con ayuda de t�cnicas tradicionales o de alta tecnolog�a, todas ellas realizadas de forma interna. Para recortar las celdillas y crear las estr�as de las ranuras que las separan, se utiliza un l�ser de femtosegundo. La esfera est� engastada de 10�diamantes talla  para marcar las horas.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m127286tbr-0001-dial-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m127286tbr-0001-dial-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127286tbr-0001 esfera" />
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">Bisel engastado de diamantes</p>
                                <p className="body-20-light">Los engastadores, al igual que los escultores, modelan los metales preciosos para preparar el espacio donde alojar�n perfectamente cada piedra preciosa de forma manual. Con el arte y savoir-faire de los joyeros, cada piedra se alinea meticulosamente hasta engastarla de forma segura en el oro o en el platino. Adem�s de la calidad intr�nseca de las piedras, otros factores contribuyen a la belleza del engaste de piedras de Rolex: la alineaci�n precisa del tama�o de las piedras, su orientaci�n y posici�n, la regularidad, la solidez y las proporciones del engaste, as� como el acabado del trabajo en metal. Una combinaci�n m�gica de luces que embellece el reloj y hechiza a quien lo lleva.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m127286tbr-0001-bezel-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m127286tbr-0001-bezel-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127286tbr-0001 bisel" />
                                    </picture>
                                </div>
                                <div className="pb-90-60">
                                    <p className="headline50 c-brown-text pb-20">Platino</p>
                                    <p className="body-20-light">Escaso y precioso, el platino sorprende por su blancura plateada y su vibrante luminosidad. Es uno de los metales m�s densos y m�s pesados del mundo, y se distingue por propiedades qu�micas y f�sicas �nicas, como su excepcional resistencia a la corrosi�n. Parad�jicamente, tambi�n es el�stico y sumamente maleable, por lo que su manufactura y pulido son especialmente dif�ciles y exigen una gran habilidad. Rolex emplea platino�950, una aleaci�n compuesta por 950�� (mil�simas) de platino, meticulosamente preparada en nuestros talleres por los excelentes artesanos metal�rgicos de Rolex. El m�s noble de los metales para el m�s prestigioso de los relojes.</p>
                                </div>
                            </div>
                        </div>
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m127286tbr-0001-material-portrait.webp" />
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m127286tbr-0001-material-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127286tbr-0001 material" />
                                </picture>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            ...
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Land-Dwellere m127286tbr-0001 caja presentaci�n"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127286tbr-0001-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
                ...
                <section className="c-lightbeige-bg">
                    <div className="rlx-container-content py-90-60">
                            ...
                            <div className="col-6-12">
                                <a href="https://devjhernandez--glauser.myvtex.com/rolex/watches/land-dweller/">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-banners/rolex-collection-banner-land-dweller-m127334-0001-portrait.webp"
                                        />
                                        <img
                                            alt="Colecci�n Rolex Land-Dweller"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-banners/rolex-collection-banner-land-dweller-m127334-0001-landscape.webp"
                                        />
                                    </picture>
                                </a>
                            </div>
                        ...
                        <div className="row-grid-fullw component-2-col">
                            <div className="col-lg-2-6">
                                <div className="pt-10">
                                    <p className="fixed-16 c-brown-text">Rolex Land-Dweller</p>
