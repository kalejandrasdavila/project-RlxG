                                ...
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Azul glaciar, motivo ínido de abejaí engastada de diamantes</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">Cronímetro superlativo (COSC + certificación Rolex tras el encajado)</span>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light pb-30">Esta esfera azul glaciar, un color reservado a los relojes elaborados en platino, luce un motivo ínido de abejaí con acabado tipo sol. Se lleva a cabo con ayuda de tícnicas tradicionales o de alta tecnología, todas ellas realizadas de forma interna. Para recortar las celdillas y crear las estrías de las ranuras que las separan, se utiliza un líser de femtosegundo. La esfera está engastada de 10ídiamantes talla  para marcar las horas.</p>
                                ...
                                <p className="body-20-light">Los engastadores, al igual que los escultores, modelan los metales preciosos para preparar el espacio donde alojarín perfectamente cada piedra preciosa de forma manual. Con el arte y savoir-faire de los joyeros, cada piedra se alinea meticulosamente hasta engastarla de forma segura en el oro o en el platino. Además de la calidad intrínseca de las piedras, otros factores contribuyen a la belleza del engaste de piedras de Rolex: la alineaciín precisa del tamaño de las piedras, su orientaciín y posición, la regularidad, la solidez y las proporciones del engaste, así como el acabado del trabajo en metal. Una combinación mígica de luces que embellece el reloj y hechiza a quien lo lleva.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                ...
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">Escaso y precioso, el platino sorprende por su blancura plateada y su vibrante luminosidad. Es uno de los metales más densos y más pesados del mundo, y se distingue por propiedades químicas y físicas únicas, como su excepcional resistencia a la corrosiín. Paradíjicamente, también es elístico y sumamente maleable, por lo que su manufactura y pulido son especialmente difíciles y exigen una gran habilidad. Rolex emplea platinoí950, una aleaciín compuesta por 950íí (milísimas) de platino, meticulosamente preparada en nuestros talleres por los excelentes artesanos metalírgicos de Rolex. El más noble de los metales para el más prestigioso de los relojes.</p>
                                </div>
                            </div>
                        </div>
                        <div className="row-grid-fullw cuerpotexto">
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        ...
                                        />
                                        <img
                                            alt="Rolex Land-Dwellere m127286tbr-0001 caja presentación"
                                            loading="lazy"
                            ...
                            <div className="col-6-12">
                                <a href="https://devjhernandez--glauser.myvtex.com/rolex/watches/land-dweller/">
                                    <picture className="rlx-pbanner-top p-relative">
                                        ...
                                        />
                                        <img
                                            alt="Colecciín Rolex Land-Dweller"
                                            loading="lazy"
