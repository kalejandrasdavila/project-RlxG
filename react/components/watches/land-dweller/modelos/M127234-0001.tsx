...
const M1272340001: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Land-Dweller 36 de Oyster, 36 mm, acero Oystersteel y oro blanco, m127234-0001 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Land-Dweller 36 de Oyster, 36 mm, acero Oystersteel y oro blanco en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-drp-upright-bba-with-shadow-landscape.webp"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Land-Dweller 36 de Oyster, 36 mm, acero Oystersteel y oro blanco en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m127234-0001",
                        "mpn": "127234",
                            ...
                            <div className="col-6-4-3 pb-90-60">
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light">m127234-0001</span>
                                    </h1>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="swiper-slider">
                                                <picture className="rlx-pbanner-top p-relative">
                                                    ...
                                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-drp-upright-bba-with-shadow-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127234-0001 reloj" />
                                                </picture>
                                            </div>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-gallery1-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127234-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-gallery2-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127234-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-gallery3-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127234-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-gallery4-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127234-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        ...
                        <div id="lightbox" className="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img id="lightbox-image" src="" alt="m127234-0001 reloj galeria" />
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                            <div className="row-grid-6-12-7 pt-90-60 cuerpotextobeigebg">
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">127234</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-6-12-7 border-top-brown p-relative" style={{ marginTop: "30px" }}>
                                    <div className="p-absolutes">
                                        <a href="https://assets.rolex.com/api/brochure/es/land-dweller/m127234-0001.pdf" target="_blank" className="btn-primary-icon-rlx">
                            ...
                            <div className="col-6-6-5-3 order-1-mob" style={{ display: "none" }}>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-cor-specs-portrait.webp" />
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-cor-specs-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127234-0001 especificaciones" />
                                </picture>
                            </div>
                        </div>
                    </div>
                ...
                <section className="c-lightbeige-bg">
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m127234-0001-dial-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m127234-0001-dial-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127234-0001 esfera" />
                                    </picture>
                                </div>
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m127234-0001-bezel-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m127234-0001-bezel-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127234-0001 bisel" />
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m127234-0001-material-portrait.webp" />
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m127234-0001-material-landscape.webp" loading="lazy" alt="Rolex Land-Dweller m127234-0001 material" />
                                </picture>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            ...
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Land-Dwellere m127234-0001 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m127234-0001-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
