...
const M3369380007: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Sky-Dweller de Oyster, 42 mm, oro amarillo, m336938-0007 - GLAUSER</title>
                <meta
                    name="description"
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336938-0007/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336938-0007/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Sky-Dweller de Oyster, 42 mm, oro amarillo, m336938-0007 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336938-0007-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336938-0007/" />
                <meta
                    name="twitter:title"
                    content="Rolex Sky-Dweller de Oyster, 42 mm, oro amarillo, m336938-0007 - GLAUSER"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336938-0007/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336938-0007/",
                                "name": "Rolex Sky-Dweller de Oyster, 42 mm, oro amarillo, m336938-0007 - GLAUSER",
                                ...
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336938-0007/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336938-0007/"] }]
                            }
                        ]
                    `}
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "name": "Sky-Dweller",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336938-0007-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Sky-Dweller de Oyster, 42 mm, oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m336938-0007",
                        "mpn": "336938",
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336938-0007/">m336938-0007
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="col-6-4-3 pb-90-60">
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light">m336938-0007</span>
                                    </h1>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="swiper-slider">
                                                <picture className="rlx-pbanner-top p-relative">
                                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-drp-upright-bba-with-shadow-portrait.webp" />
                                                    <img src="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-drp-upright-bba-with-shadow-landscape.webp" loading="lazy" alt="Rolex Sky-Dweller m336938-0007 reloj" />
                                                </picture>
                                            </div>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery1-landscape.webp" loading="lazy" alt="Rolex Sky-Dweller m336938-0007 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery2-landscape.webp" loading="lazy" alt="Rolex Sky-Dweller m336938-0007 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery3-landscape.webp" loading="lazy" alt="Rolex Sky-Dweller m336938-0007 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery4-landscape.webp" loading="lazy" alt="Rolex Sky-Dweller m336938-0007 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw galeria-models">
                            <div className="span-3-1">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        ...
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery1-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sky-Dweller m336938-0007 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery1-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-2">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery2-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sky-Dweller m336938-0007 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery2-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-3">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery3-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sky-Dweller m336938-0007 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery3-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-4">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery4-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sky-Dweller m336938-0007 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-gallery4-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        <div className="lightbox" id="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img alt="m336938-0007 reloj galeria" id="lightbox-image" src="" />
                        ...
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                                ...
                                <div
                                    ...
                                    <div className="p-absolutes">
                                        <a
                                            ...
                                            href="https://assets.rolex.com/api/brochure/es/sky-dweller/m336938-0007.pdf"
                                            target="_blank">
                                            <svg
                            ...
                            <div
                                ...
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-cor-specs-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sky-Dweller m336938-0007 especificaciones"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/watches-models/m336938-0007-cor-specs-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                ...
                <section className="c-lightbeige-bg">
                    <div className="rlx-container-content py-90-60">
                            ...
                            <div className="col-text-center">
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        ...
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m336938-0007-dial-landscape.webp" loading="lazy" alt="Rolex Sky-Dweller m336938-0007 esfera" />
                                    </picture>
                                </div>
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        ...
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m336938-0007-bezel-landscape.webp" loading="lazy" alt="Rolex Sky-Dweller m336938-0007 bisel" />
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m336938-0007-material-portrait.webp" />
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m336938-0007-material-landscape.webp" loading="lazy" alt="Rolex Sky-Dweller m336938-0007 material" />
                                </picture>
                            </div>
                        </div>
                    </div>
