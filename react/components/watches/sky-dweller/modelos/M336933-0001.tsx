...
const M3369330001: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Sky-Dweller de Oyster, 42 mm, acero Oystersteel y oro amarillo, m336933-0001 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Sky-Dweller de Oyster, 42 mm, acero Oystersteel y oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336933-0001/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336933-0001/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Sky-Dweller de Oyster, 42 mm, acero Oystersteel y oro amarillo, m336933-0001 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336933-0001/" />
                <meta
                    name="twitter:title"
                    content="Rolex Sky-Dweller de Oyster, 42 mm, acero Oystersteel y oro amarillo, m336933-0001 - GLAUSER"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336933-0001/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336933-0001/",
                                "name": "Rolex Sky-Dweller de Oyster, 42 mm, acero Oystersteel y oro amarillo, m336933-0001 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Sky-Dweller de Oyster, 42 mm, acero Oystersteel y oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336933-0001/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336933-0001/"] }]
                            }
                        ]
                    `}
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "name": "Sky-Dweller",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Sky-Dweller de Oyster, 42 mm, acero Oystersteel y oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m336933-0001",
                        "mpn": "336933",
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "itemListElement": [{
                            ...
                            "position": 3,
                            "name": "Sky-Dweller",
                            "item": "https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/"
                        }, {
                            "@type": "ListItem",
                            "position": 4,
                            "name": "m336933-0001"
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14">
                                        <a href="https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/">
                                            Sky-Dweller
                                        </a>
                                    </li>
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/sky-dweller/m336933-0001/">m336933-0001
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light block block">
                                            Oyster, 42 mm, acero Oystersteel y oro amarillo
                                        </span>
                                        <span className="body-20-light">m336933-0001</span>
                                    </h1>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="swiper-slider">
                                                <picture className="rlx-pbanner-top p-relative">
                                                    ...
                                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-drp-upright-bba-with-shadow-landscape.webp" loading="lazy" alt="Rolex Sky-Dweller m336933-0001 reloj" />
                                                </picture>
                                            </div>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery1-landscape.webp" loading="lazy" alt="Rolex Sky-Dweller m336933-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery2-landscape.webp" loading="lazy" alt="Rolex Sky-Dweller m336933-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery3-landscape.webp" loading="lazy" alt="Rolex Sky-Dweller m336933-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery4-landscape.webp" loading="lazy" alt="Rolex Sky-Dweller m336933-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw galeria-models">
                            <div className="span-3-1">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        ...
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery1-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sky-Dweller m336933-0001 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery1-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-2">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery2-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sky-Dweller m336933-0001 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery2-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-3">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery3-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sky-Dweller m336933-0001 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery3-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-4">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery4-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sky-Dweller m336933-0001 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-gallery4-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        <div className="lightbox" id="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img alt="m336933-0001 reloj galeria" id="lightbox-image" src="" />
                        ...
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">336933</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">
                                                Estriado, giratorio bidireccional Rolex Ring Command
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-3-5-3-2">
                                    <ul className="list-especification-model-rlx ">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">9002, Manufactura Rolex</span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Color champagne</span>
                                        </li>
                                        <li>
                                ...
                                <div
                                    ...
                                    <div className="p-absolutes">
                                        <a
                                            ...
                                            href="https://assets.rolex.com/api/brochure/es/sky-dweller/m336933-0001.pdf"
                                            target="_blank">
                                            <svg
                            ...
                            <div
                                ...
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-cor-specs-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sky-Dweller m336933-0001 especificaciones"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-cor-specs-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <p className="headline50 c-brown-text pb-20">Esfera color champagne</p>
                                <p className="body-20-light pb-30">
                                    Un triángulo rojo fijo invertido en la esfera seíala la hora de
                                    referencia íla hora del lugar de origen o del lugar usual del trabajo
                                    del propietarioí en el disco de 24 horas descentrado. De un solo
                                    vistazo, esta visualización de 24 horas distingue claramente las horas
                                    del día y las de la noche en el otro huso horario.
                                </p>
                                <p className="body-20-light">
                                    Un rectíngulo de color rojo oscuro en una de las 12 ventanas sobre la
                                    esfera indica el mes en curso, una característica propia del
                                    calendario anual Saros. Este ingenioso mecanismo simplifica la vida
                                    del usuario del reloj, que no ha de preocuparse de modificar la fecha
                                    al final de los meses de 30 días. El calendario anual da la fecha
                                    correcta a lo largo de todo el año. Sílo necesita ajustarse una vez:
                                    el 1 de marzo (ya que el mes de febrero cuenta con 28 o 29 días). La
                                    fecha está conectada a la hora local y cambia automáticamente en
                                    función de la hora local del viajero.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m336933-0001-dial-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Sky-Dweller m336933-0001 esfera"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m336933-0001-dial-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">El bisel estriado</p>
                                <p className="body-20-light">
                                    El bisel estriado de Rolex es una marca de distinciín. En un
                                    principio, el diseño estriado del bisel Oyster tenía una función
                                    específica: servía para atornillar el bisel a la caja garantizando la
                                    hermeticidad del reloj. Además, era idíntico al acanalado del fondo de
                                    la caja, atornillado a ísta por la misma razín, mediante herramientas
                                    específicas de Rolex. Con el tiempo, el estriado se convirtió en un
                                    elemento puramente estático, una auténtica característica distintiva
                                    de Rolex. En la actualidad, el estriado es una marca de distinciín y
                                    está disponible únicamente en los modelos en oro. El Sky-Dweller
                                    dispone de un mecanismo de interacciín entre el bisel giratorio, la
                                    corona y el movimiento: el sistema Ring Command, que permite al
                                    usuario del reloj seleccionar las funciones una tras otra y ajustarlas
                                    de manera simple, rípida y segura.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m336933-0001-bezel-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Sky-Dweller m336933-0001 bisel"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m336933-0001-bezel-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">
                                        El oro es codiciado por su lustre y su nobleza. El acero afianza la
                                        fuerza y la fiabilidad. Juntos, combinan armoniosamente lo mejor de
                                        sus propiedades. Verdadera firma de Rolex, el Rolesor ha sido parte
                                        de los modelos Rolex desde principios de los años treinta y fue
                                        patentado como nombre en 1933. Es uno de los prominentes pilares de
                                        la colecciín Oyster.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m336933-0001-material-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sky-Dweller m336933-0001 material"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m336933-0001-material-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Sky-Dweller m336933-0001 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m336933-0001-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
