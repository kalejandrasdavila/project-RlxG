                    ...
                    <div className="rlx-container-content py-90-60">
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <p className="headline50 c-brown-text pb-20">Inmensamente innovador, el Sky-Dweller combina la sofisticación mecánica con una visualización original.</p>
                                <p className="body-20-light">Desde su creación en 2012, el Sky-Dweller se ha dirigido a quienes ven el mundo como un territorio único, sin fronteras. Permite a los viajeros evitar los obstáculos de las diferencias horarias e ir siempre un paso por delante.</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="rlx-container-content py-90-60">
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light pb-30">El calendario anual Saros patentado, especialmente desarrollado para el Sky-Dweller, es un elemento clave en la identidad del modelo. El nombre de este mecanismo, con su innovador diseño, se inspira en el término griego que designa el ciclo de los eclipses lunar y solar.</p>
                                <p className="body-20-light pb-30">El calendario Saros distingue automáticamente los meses de 30 días de los de 31 días. Por tanto, solo necesita un único ajuste manual de la fecha al año, en el paso de febrero a marzo. Es intuitivo y fácil de leer. El mes en curso se indica en rojo en una de las doce ventanas que marcan los índices sobre el contorno de la esfera.</p>
                                <p className="body-20-light">La innovación en relojería se basa en dos relaciones de transmisión y solo cuatro trenes de ruedas añadidos al calendario de fecha instantánea de Rolex. Esta estructura elemental confiere al calendario anual Saros una excelente fiabilidad.</p>
                                ...
                                <p className="body-20-light pb-30">El sistema Ring Command desarrollado por Rolex y patentado es un innovador mecanismo de interacción entre el bisel giratorio, la corona y el movimiento. Permite seleccionar las distintas funciones del Sky-Dweller de forma fácil, rápida y segura, antes de ajustarlas con la corona.</p>
                                <p className="body-20-light">Girando el bisel estriado en el sentido contrario a las agujas del reloj –cuyo perfil está acentuado para facilitar su manejo– el usuario elige la indicación que desea configurar. Primera muesca: fecha y mes. Segunda muesca: hora local. Tercera muesca: hora de referencia.</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="rlx-container-content py-90-60">
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">El golfista español Jon Rahm, el capitán brasileño Robert Scheidt y el jinete de salto de obstáculos estadounidense Kent Farrington están entre los Testimoniales Rolex que han adoptado el Sky-Dweller.</p>
                            </div>
                        </div>
                    </div>
                </section>
