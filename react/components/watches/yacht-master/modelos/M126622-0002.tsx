                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">
                                        Muchos relojes Rolex están disponibles con la legendaria combinación
                                        de oro amarillo, blanco o Everose y acero, conocida como Rolesor,
                                        pero Rolesium es una creación específica del Yacht-Master. En las
                                        ...
                                        plateada y una vibrante luminosidad para una inconfundible sensaciín
                                        de lujo.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        ...
                                        />
                                        <img
                                            alt="Rolex Yacht-Master m126622-0002 caja presentación"
                                            loading="lazy"
