                                    ...
                                    <ul className="list-especification-model-rlx">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">
                                                ...
                                                Cerachrom en cer�mica negro mate, n�meros y graduaciones en
                                                relieve y pulidos
                                            </span>
                                        </li>
                                    </ul>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">
                                        El titanio RLX es una aleaci�n de titanio grado 5 especialmente
                                        seleccionada por Rolex. Como cualquier aleaci�n de titanio, se
                                        distingue por su ligereza y por su resistencia mec�nica a la
                                        corrosi�n. El titanio RLX se caracteriza adem�s por el hecho de que
                                        ...
                                        elevada resistencia mec�nica, resulta dif�cil de manipular y su uso
                                        ha requerido, por tanto, el desarrollo de procesos de fabricaci�n
                                        espec�ficos.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        ...
                                        />
                                        <img
                                            alt="Rolex Yacht-Master m226627-0001 caja presentaci�n"
                                            loading="lazy"
