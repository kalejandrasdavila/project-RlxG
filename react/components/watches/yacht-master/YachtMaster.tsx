                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw text-introduccion pb-90-60">
                            ...
                            <div className="col-lg-8-5">
                                <p className="body-20-light"><strong>Lanzado en 1992, el Yacht-Master fue especialmente diseñado para navegantes y capitanes.</strong> Este reloj de la categoría Profesional, que aúna a la perfección funcionalidad y estilo náutico, se desenvuelve con soltura tanto en el mar como en tierra firme.</p>
                            </div>
                        </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <p className="body-20-light">El Oyster Perpetual Yacht-Master simboliza la unión entre Rolex y el mundo de la vela desde los años 1950. Desarrollado especialmente para responder a las exigencias y necesidades de los navegantes, es un reloj técnico, elegante y deportivo, pero, sobre todo, un instrumento útil y fiable a bordo de un barco.</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="rlx-container-content py-90-60">
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">Robusto, adecuado y perfectamente hermético: el Yacht-Master es uno de los relojes Profesionales Rolex disponible en varios diámetros (37, 40 y 42 mm).</p>
                                ...
                                <p className="body-20-light">El Yacht-Master 42 está disponible en oro amarillo y blanco de 18 quilates con un brazalete Oysterflex y en titanio RLX —aleación que se distingue por su ligereza y sus cualidades de alta resistencia mecánica a la corrosión— con un brazalete Oyster. Esta versión, presentada en 2023, destaca por su acabado satinado técnico, un acabado con grano visible.</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="rlx-container-content py-90-60">
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">Los modelos Yacht-Master están equipados con el calibre 2236 (Yacht Master 37) o con el calibre 3235 (Yacht Master 40 y Yacht Master 42), movimientos mecánicos de cuerda automática completamente desarrollados y manufacturados por Rolex. Presentan un elevado rendimiento en términos de precisión, autonomía, comodidad de uso y fiabilidad. El calibre 2236 cuenta con una reserva de marcha de aproximadamente 55 horas, y el calibre 3235 de aproximadamente 70 horas.</p>
                            </div>
                        </div>
                    </div>
                </section>
