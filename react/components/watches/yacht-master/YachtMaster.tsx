    ...
    return (
        <>
            <Helmet>
                ...
                <link rel="canonical" href="https://glauser.myvtex.com/rolex/watches/yacht-master/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://glauser.myvtex.com/rolex/watches/yacht-master/" />
                ...
                <meta property="twitter:url" content="https://glauser.myvtex.com/rolex/watches/yacht-master/" />
                <meta
                    name="twitter:title"
                    content="Relojes Rolex Yacht-Master - GLAUSER"
                />
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://glauser.myvtex.com/rolex/watches/yacht-master/#webpage",
                                "url": "https://glauser.myvtex.com/rolex/watches/yacht-master/",
                                ...
                                "breadcrumb": { "@id": "https://glauser.myvtex.com/rolex/watches/yacht-master/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": {
                                    "@type": "ReadAction",
                                    "target": "https://glauser.myvtex.com/rolex/watches/yacht-master/"
                                }
                            }
                        ]
                    })}
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil active">
                                        <a className="active" href="https://glauser.myvtex.com/rolex/watches/yacht-master/">Yacht-Master</a>
                                    </li>
                                </ul>
                            </div>
                ...
                <section className="c-lightbeige-bg">
                    <div className="rlx-container-content py-90-60">
                        ...
                        <div className="row-grid-fullw reloes-componet-2-3">
                            <div className="col-span3-1 col-md-span4-1 c-beige-bg">
                                <div className="pt-0-5vh text-center">
                                    <a href="https://glauser.myvtex.com/rolex/watches/yacht-master/m226627-0001/">
                            ...
                            <div className="col-span3-2 col-md-span4-2 c-beige-bg">
                                <div className="pt-0-5vh text-center">
                                    <a href="https://glauser.myvtex.com/rolex/watches/yacht-master/m268622-0002/">
                                        <picture className="rlx-pbanner-top watch-ind p-relative">
                            ...
                            <div className="col-span3-1 col-md-span4-3 c-beige-bg">
                                <div className="pt-0-5vh text-center">
                                    <a href="https://glauser.myvtex.com/rolex/watches/yacht-master/m126655-0002/">
                                        <picture className="rlx-pbanner-top watch-ind p-relative">
                            ...
                            <div className="col-span3-2 col-md-span4-1 c-beige-bg">
                                <div className="pt-0-5vh text-center">
                                    <a href="https://glauser.myvtex.com/rolex/watches/yacht-master/m126621-0002/">
                                        <picture className="rlx-pbanner-top watch-ind p-relative">
                            ...
                            <div className="col-span3-1 col-md-span4-2 c-beige-bg">
                                <div className="pt-0-5vh text-center">
                                    <a href="https://glauser.myvtex.com/rolex/watches/yacht-master/m126622-0001/">
                                        <picture className="rlx-pbanner-top watch-ind p-relative">
                            ...
                            <div className="col-span3-2 col-md-span4-3 c-beige-bg">
                                <div className="pt-0-5vh text-center">
                                    <a href="https://glauser.myvtex.com/rolex/watches/yacht-master/m226659-0002/">
                                        <picture className="rlx-pbanner-top watch-ind p-relative">
                        ...
                        <div id="masrelojescargados" className="row-grid-fullw reloes-componet-2-3 d-none-rlx pt-8">
                            <div className="col-span3-1 col-md-span4-1 c-beige-bg">
                                <div className="pt-0-5vh text-center">
                                    <a href="https://glauser.myvtex.com/rolex/watches/yacht-master/m126622-0002/">
                                        <picture className="rlx-pbanner-top watch-ind p-relative">
                            ...
                            <div className="col-span3-2 col-md-span4-2 c-beige-bg">
                                <div className="pt-0-5vh text-center">
                                    <a href="https://glauser.myvtex.com/rolex/watches/yacht-master/m268621-0003/">
                                        <picture className="rlx-pbanner-top watch-ind p-relative">
