...
const YachtMaster = () => {
    ...
    useWatchCollectionMeta({
        title: 'Relojes Rolex Yacht-Master - GLAUSER',
        ...
        canonicalUrl: 'https://glauser.myvtex.com/rolex/watches/yacht-master/',
        ogImage: 'https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-banners/rolex-collection-banner-yacht-master-m226627-0001-portrait.webp',
