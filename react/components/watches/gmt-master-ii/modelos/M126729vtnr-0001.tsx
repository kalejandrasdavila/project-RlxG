                                ...
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Cer�mica verde</span>
                                        </li>
                                        <li>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">
                                    Este modelo presenta una esfera cer�mica verde y un disco de bisel
                                    Cerachrom bicolor en cer�mica verde y negra bicolor. El GMT-Master�II
                                    ...
                                    El disco de bisel Cerachrom, por su parte, presenta una combinaci�n
                                    in�dita de colores: un negro y un verde exclusivo de este modelo.
                                </p>
                                ...
                                <p className="headline50 c-brown-text pb-20">
                                    Esfera de cer�mica verde
                                </p>
                                <p className="body-20-light">
                                    La esfera Cerachrom �elaborada seg�n el mismo principio que las de
                                    piedra natural, es decir, un disco de material fijado sobre una base
                                    de lat�n� presenta un tono verde id�ntico al de la mitad inferior del
                                    disco de bisel Cerachom bicolor verde y negro del que est� dotado el
                                    reloj. Es la primera esfera Cerachrom en un reloj Rolex. En esta
                                    versi�n in�dita, la corona de cuerda, as� como los protectores de la
                                    corona, se sit�an en el lado izquierdo de la caja. La ventana de la
                                    fecha, coronada por la lente Cyclops se ubica en la posici�n de las
                                    9�h.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        ...
                                        />
                                        <img
                                            alt="Rolex GMT-Master II m126729vtnr-0001 caja presentaci�n"
                                            loading="lazy"
