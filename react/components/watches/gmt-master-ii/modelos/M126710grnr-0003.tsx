                                    ...
                                    <ul className="list-especification-model-rlx">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">
                                                ...
                                                Cerachrom bicolor en cer�mica gris y negra, n�meros y
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">
                                    ...
                                    bicolor en cer�mica gris y negra bicolor. El GMT-Master II dispone de
                                ...
                                <p className="body-20-light pb-30">
                                    En la esfera lacada negra, destaca el color verde de la inscripci�n
                                    �GMT-Master II�. Este color tambi�n aparece en la aguja 24 horas.
                                </p>
                                <p className="body-20-light">
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        ...
                                        />
                                        <img
                                            alt="Rolex GMT-Master II m126710grnr-0003 caja presentaci�n"
                                            loading="lazy"
