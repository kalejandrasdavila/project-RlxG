                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">El GMT-Master�II cuenta con una esfera de ojo de hierro. Esta roca metam�rfica, nunca antes utilizada por Rolex en este reloj, se distingue por la riqueza de su textura. Compuesta por tres minerales �ojo de tigre, jaspe rojo y hematita plateada�, esta piedra arroja reflejos dorados y anaranjados que un cuidado trabajo de selecci�n y montaje ha permitido armonizar con los tonos de la caja y el brazalete.</p>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        ...
                                        />
                                        <img
                                            alt="Rolex GMT-Master II m126718grnr-0002 caja presentaci�n"
                                            loading="lazy"
