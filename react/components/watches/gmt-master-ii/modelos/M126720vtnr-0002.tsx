                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">
                                                Bisel giratorio bidireccional, graduado 24 horas. Disco Cerachrom bicolor verde y negro de cer�mica, n�meros y graduaciones moldeados
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">Este modelo presenta una esfera negra y un disco de bisel Cerachrom bicolor en cer�mica verde y negra bicolor. El GMT-Master�II dispone de una aguja adicional que da la vuelta a la esfera en 24�horas y complementa a las tradicionales agujas de las horas, minutos y segundos, as� como de un bisel giratorio bidireccional graduado 24�horas. La aguja adicional de 24�horas, con su color distintivo, indica la hora de referencia, la del lugar de residencia, en un primer huso horario que se lee sobre la graduaci�n del bisel. La hora local del viajero puede ajustarse f�cilmente mediante saltos de hora en hora gracias a un astuto mecanismo controlado por la corona: la aguja de las horas puede ajustarse hacia delante o hacia atr�s, de forma independiente del minutero y el segundero. Esto permite al viajero adaptar su nuevo huso horario sin que afecte a la precisi�n. El disco de bisel Cerachrom, por su parte, presenta una combinaci�n in�dita de colores: un negro y un verde exclusivo de este modelo.</p>
                                ...
                                <p className="body-20-light pb-30">Como todos los relojes Profesionales de Rolex, el GMT-Master�II ofrece una gran legibilidad en cualquier circunstancia, especialmente en la oscuridad, gracias a su visualizaci�n Chromalight. Sus amplias agujas y sus �ndices de formas simples �tri�ngulos, c�rculos, rect�ngulos� est�n recubiertos de un material luminiscente de larga duraci�n.</p>
                                <p className="body-20-light">En esta versi�n in�dita del reloj, la corona de cuerda, as� como los protectores de la corona, se sit�an en el lado izquierdo de la caja. La ventana de la fecha, coronada por la lente Cyclops se ubica en la posici�n de las 9�h.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                ...
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">Rolex utiliza acero Oystersteel para las cajas de acero de sus relojes. Especialmente desarrollado por Rolex, el acero Oystersteel pertenece a la familia del acero 904L, las aleaciones m�s utilizadas en la alta tecnolog�a y en las industrias qu�mica y aeroespacial, en las que la resistencia a la corrosi�n es esencial. El acero Oystersteel es extremadamente resistente, ofrece un acabado excepcional al ser pulido y conserva su belleza incluso en las condiciones m�s extremas.</p>
                                </div>
                            </div>
                        </div>
                        <div className="row-grid-fullw cuerpotexto">
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        ...
                                        />
                                        <img
                                            alt="Rolex GMT-Master II m126720vtnr-0002 caja presentaci�n"
                                            loading="lazy"
