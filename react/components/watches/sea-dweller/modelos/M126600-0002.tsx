    ...
    return (
        <>
            <Helmet>
                ...
                <link rel="canonical" href="http://localhost:3000/rolex/watches/sea-dweller/m126600-0002/" />
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="http://localhost:3000/rolex/watches/sea-dweller/m126600-0002/">m126600-0002
                                        </a>
                                    </li>
                                </ul>
                            </div>
