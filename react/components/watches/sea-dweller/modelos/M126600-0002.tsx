...
const CSS_HANDLES = [
    'container', 'wrapper', 'content', 'model_container', 'section', 'hero_section'
] as const;

const M1266000002: React.FC = () => {
    useInitScripts();
    ...
    useEffect(() => {
        ...
        const elemento = document.getElementById("mensajerlx") as HTMLInputElement | HTMLTextAreaElement | null;
        if (elemento) {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel, m126600-0002 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://glauser.myvtex.com/rolex/watches/sea-dweller/m126600-0002/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://www.glauser.com.co/rolex/watches/sea-dweller/m126600-0002/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel, m126600-0002 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://www.glauser.com.co/rolex/watches/sea-dweller/m126600-0002/" />
                <meta
                    name="twitter:title"
                    content="Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel, m126600-0002 - GLAUSER"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://www.glauser.com.co/rolex/watches/sea-dweller/m126600-0002/#webpage",
                                "url": "https://www.glauser.com.co/rolex/watches/sea-dweller/m126600-0002/",
                                "name": "Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel, m126600-0002 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://www.glauser.com.co/rolex/watches/sea-dweller/m126600-0002/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://www.glauser.com.co/rolex/watches/sea-dweller/m126600-0002/"] }]
                            }
                        ]
                   `}
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "name": "Sea-Dweller",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m126600-0002",
                        "mpn": "126600",
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "itemListElement": [{
                            ...
                            "position": 3,
                            "name": "Sea-Dweller",
                            "item": "https://www.glauser.com.co/rolex/watches/sea-dweller/"
                        }, {
                            "@type": "ListItem",
                            "position": 4,
                            "name": "m126600-0002"
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://glauser.myvtex.com/rolex/watches/sea-dweller/m126600-0002/">m126600-0002
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light block block">
                                            Oyster, 43 mm, acero Oystersteel
                                        </span>
                                        <span className="body-20-light">m126600-0002</span>
                                    </h1>
                            ...
                            <div className="col-6-6-4 order-1-mob">
                                <div className="swiper swiper-container-mobile">
                                    <div className="swiper-wrapper">
                                        ...
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery1-landscape.webp" loading="lazy" alt="Rolex Sea-Dweller m126600-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery2-landscape.webp" loading="lazy" alt="Rolex Sea-Dweller m126600-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery3-landscape.webp" loading="lazy" alt="Rolex Sea-Dweller m126600-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery4-landscape.webp" loading="lazy" alt="Rolex Sea-Dweller m126600-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw galeria-models">
                            <div className="span-3-1">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        ...
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery1-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sea-Dweller m126600-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery1-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-2">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery2-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sea-Dweller m126600-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery2-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-3">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery3-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sea-Dweller m126600-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery3-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-4">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery4-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sea-Dweller m126600-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-gallery4-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        <div className="lightbox" id="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img alt="m126600-0002 reloj galeria" id="lightbox-image" src="" />
                        ...
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">126600</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">
                                                Hermético hasta 1229 metros/ 4000 pies, válvula de helio
                                            </span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Bisel</span>
                                            <span className="body-20-light">
                                                Giratorio unidireccional graduado 60 minutos, disco Cerachrom de
                                                cerámica negra resistente a las rayaduras, números y
                                                graduaciones recubiertos en platino
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-3-5-3-2">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">43 mm</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Brazalete</span>
                                            <span className="body-20-light">
                                                Oyster (3 elementos), eslabones macizos
                                            </span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Negro intenso</span>
                                        </li>
                                        <li>
                                ...
                                <div
                                    ...
                                    <div className="p-absolutes">
                                        <a
                                            ...
                                            href="https://assets.rolex.com/api/brochure/es/sea-dweller/m126600-0002.pdf"
                                            target="_blank">
                                            <svg
                                                aria-hidden="true"
                                                fill="white"
                            ...
                            <div
                                ...
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-cor-specs-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sea-Dweller m126600-0002 especificaciones"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-cor-specs-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">
                                    El bisel giratorio unidireccional graduado 60 minutos del Sea-Dweller
                                    permite visualizar los tiempos de inmersión y descompresión con total
                                    seguridad. Está equipado con un disco de bisel Cerachrom negro
                                    patentado y fabricado por Rolex en una cerámica prácticamente
                                    imposible de rayar o alterar por los rayos ultravioleta. La graduación
                                    se obtiene por PVD (Physical Vapour Deposition) de una fina capa de
                                    platino. La esfera aloja grandes índices y agujas Chromalight,
                                    recubiertas de un material luminiscente de larga duración, que emite
                                    un color azul para una excelente legibilidad en la oscuridad.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126600-0002-dial-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Sea-Dweller m126600-0002 bisel"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126600-0002-dial-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">Esfera negro intenso</p>
                                <p className="body-20-light">
                                    La esfera negra del Sea-Dweller posee índices y agujas de gran tamaño
                                    reservados para los modelos Profesionales. La esfera lleva el nombre
                                    de «Sea-Dweller» escrito en rojo, en referencia al primer modelo. La
                                    innovadora visualización Chromalight de la esfera rompe las barreras
                                    de la visibilidad en los ambientes más oscuros. La distintiva
                                    luminiscencia azul dura hasta 8 horas, emitiendo un brillo uniforme de
                                    una duración casi dos veces mayor que la de los materiales
                                    luminiscentes estándar.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126600-0002-bezel-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Sea-Dweller m126600-0002 esfera"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126600-0002-bezel-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">
                                        Rolex utiliza acero Oystersteel para las cajas de acero de sus
                                        relojes. Especialmente desarrollado por Rolex, el acero Oystersteel
                                        pertenece a la familia del acero 904L, las aleaciones más utilizadas
                                        en la alta tecnología y en las industrias química y aeroespacial, en
                                        las que la resistencia a la corrosión es esencial. El acero
                                        Oystersteel es extremadamente resistente, ofrece un acabado
                                        excepcional al ser pulido y conserva su belleza incluso en las
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126600-0002-material-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sea-Dweller m126600-0002 material"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126600-0002-material-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Sea-Dweller m126600-0002 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126600-0002-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
                ...
                <section className="c-lightbeige-bg">
                    <div className="rlx-container-content py-90-60">
                            ...
                            <div className="col-6-12">
                                <a href="https://glauser.myvtex.com/rolex/watches/sea-dweller/">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-banners/rolex-collection-banner-sea-dweller-m126603-0001-portrait.webp"
                                        />
                                        <img
                                            alt="Colección Rolex Sea-Dweller"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-banners/rolex-collection-banner-sea-dweller-m126603-0001-landscape.webp"
                                        />
                                    </picture>
                                </a>
                            </div>
                        ...
                        <div className="row-grid-fullw component-2-col">
                            <div className="col-lg-2-6">
                                <div className="pt-10">
                                    <p className="fixed-16 c-brown-text">Rolex Sea-Dweller</p>
