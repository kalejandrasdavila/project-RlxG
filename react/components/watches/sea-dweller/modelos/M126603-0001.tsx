...
const M1266030001: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel y oro amarillo, m126603-0001 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel y oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <meta
                    property="og:title"
                    content="Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel y oro amarillo, m126603-0001 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://www.glauser.com.co/rolex/watches/sea-dweller/m126603-0001/" />
                <meta
                    name="twitter:title"
                    content="Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel y oro amarillo, m126603-0001 - GLAUSER"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://www.glauser.com.co/rolex/watches/sea-dweller/m126603-0001/#webpage",
                                "url": "https://www.glauser.com.co/rolex/watches/sea-dweller/m126603-0001/",
                                "name": "Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel y oro amarillo, m126603-0001 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel y oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://www.glauser.com.co/rolex/watches/sea-dweller/m126603-0001/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://www.glauser.com.co/rolex/watches/sea-dweller/m126603-0001/"] }]
                            }
                        ]
                   `}
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "name": "Sea-Dweller",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Sea-Dweller de Oyster, 43 mm, acero Oystersteel y oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m126603-0001",
                        "mpn": "126603",
                                ...
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light block block">
                                            Oyster, 43 mm, acero Oystersteel y oro amarillo
                                        </span>
                                        <span className="body-20-light">m126603-0001</span>
                                    </h1>
                            ...
                            <div className="col-6-6-4 order-1-mob">
                                <div className="swiper swiper-container-mobile">
                                    <div className="swiper-wrapper">
                                        ...
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery1-landscape.webp" loading="lazy" alt="Rolex Sea-Dweller m126603-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery2-landscape.webp" loading="lazy" alt="Rolex Sea-Dweller m126603-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery3-landscape.webp" loading="lazy" alt="Rolex Sea-Dweller m126603-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery4-landscape.webp" loading="lazy" alt="Rolex Sea-Dweller m126603-0001 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw galeria-models">
                            <div className="span-3-1">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        ...
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery1-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sea-Dweller m126603-0001 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery1-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-2">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery2-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sea-Dweller m126603-0001 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery2-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-3">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery3-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sea-Dweller m126603-0001 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery3-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-4">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery4-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sea-Dweller m126603-0001 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-gallery4-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        <div className="lightbox" id="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img alt="m126603-0001 reloj galeria" id="lightbox-image" src="" />
                        ...
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">126603</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">
                                                ...
                                                graduaciones recubiertos en oro
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div
                                    ...
                                    <div className="p-absolutes">
                                        <a
                                            ...
                                            href="https://assets.rolex.com/api/brochure/es/sea-dweller/m126603-0001.pdf"
                                            target="_blank">
                                            <svg
                                                aria-hidden="true"
                                                fill="white"
                            ...
                            <div
                                ...
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-cor-specs-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sea-Dweller m126603-0001 especificaciones"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-cor-specs-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">
                                    ...
                                    oro. La sobria esfera negra aloja grandes índices y agujas
                                    Chromalight, recubiertas de un material luminiscente de larga
                                    duración, que emite un color azul, para una excelente legibilidad en
                                    la oscuridad.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126603-0001-dial-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Sea-Dweller m126603-0001 bisel"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126603-0001-dial-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                ...
                                <p className="body-20-light">
                                    ...
                                    reservados para los modelos Profesionales. La inscripción
                                    «Sea-Dweller» de color amarillo sobre la esfera negra combina con el
                                    oro amarillo. Cuando el Sea-Dweller se actualizó en 2017, esta misma
                                    inscripción aparecía en rojo, como en el modelo original. La
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126603-0001-bezel-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Sea-Dweller m126603-0001 esfera"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126603-0001-bezel-landscape.webp"
                                        />
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126603-0001-material-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Sea-Dweller m126603-0001 material"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126603-0001-material-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Sea-Dweller m126603-0001 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126603-0001-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
