...
const M2791730012: React.FC = () => {
    ...
    useWatchModelMeta({
        title: 'Rolex Lady-Datejust de Oyster, 28 mm, acero Oystersteel y oro amarillo, m279173-0012 - GLAUSER',
        ...
        canonicalUrl: 'https://glauser.myvtex.com/rolex/watches/lady-datejust/m279173-0012/',
        ogImage: 'https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m279173-0012-drp-upright-bba-with-shadow-landscape.webp',
