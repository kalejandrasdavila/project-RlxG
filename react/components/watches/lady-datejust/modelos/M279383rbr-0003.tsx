...
const M279383rbr0003: React.FC = () => {
  ...
  useWatchModelMeta({
    title: 'Rolex Lady-Datejust de Oyster, 28 mm, acero Oystersteel, oro amarillo y diamantes, m279383rbr-0003 - GLAUSER',
    ...
    canonicalUrl: 'https://glauser.myvtex.com/rolex/watches/lady-datejust/m279383rbr-0003/',
    ogImage: 'https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m279383rbr-0003-drp-upright-bba-with-shadow-landscape.webp',
