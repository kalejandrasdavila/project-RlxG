                                ...
                                <div className={`${handles.content_column_6}`}>
                                    <div className={`${handles.model_info}`}>
                                        ...
                                        <p className={`${handles.description}`}>
                                            ...
                                            Presenta una esfera negra distintiva con una combinación de números grandes de 3, 6 y 9 horas.
                                        </p>
                                        ...
                                        <div className={`${handles.specifications}`}>
                                            ...
                                            <ul>
                                                ...
                                                <li><strong>Movimiento:</strong> Perpetual, mecánico automático</li>
