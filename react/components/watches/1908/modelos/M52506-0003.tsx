...
const M525060003: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex 1908 de 39 mm, platino, acabado pulido, m52506-0003 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex 1908 de 39 mm, platino, acabado pulido en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="http://localhost:3000/rolex/watches/1908/m52506-0003/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://www.glauser.com.co/rolex/watches/1908/m52506-0003/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex 1908 de 39 mm, platino, acabado pulido, m52506-0003 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://www.glauser.com.co/rolex/watches/1908/m52506-0003/" />
                <meta
                    name="twitter:title"
                    content="Rolex 1908 de 39 mm, platino, acabado pulido, m52506-0003 - GLAUSER"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://www.glauser.com.co/rolex/watches/1908/m52506-0003/#webpage",
                                "url": "https://www.glauser.com.co/rolex/watches/1908/m52506-0003/",
                                "name": "Rolex 1908 de 39 mm, platino, acabado pulido, m52506-0003 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex 1908 de 39 mm, platino, acabado pulido en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://www.glauser.com.co/rolex/watches/1908/m52506-0003/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://www.glauser.com.co/rolex/watches/1908/m52506-0003/"] }]
                            }
                        ]
                   `}
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "name": "1908",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex 1908 de 39 mm, platino, acabado pulido en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m52506-0003",
                        "mpn": "52506",
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "itemListElement": [{
                            ...
                            "position": 3,
                            "name": "1908",
                            "item": "https://www.glauser.com.co/rolex/watches/1908/"
                        }, {
                            "@type": "ListItem",
                            "position": 4,
                            "name": "m52506-0003"
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14">
                                        <a href="http://localhost:3000/rolex/watches/1908/">
                                            1908
                                        </a>
                                    </li>
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="http://localhost:3000/rolex/watches/1908/m52506-0003/">m52506-0003
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="col-6-4-3 pb-90-60">
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="headline50 c-brown-text block mb-10">1908</span>
                                        <span className="body-20-light block block">
                                            39 mm, platino, acabado pulido
                                        </span>
                                        <span className="body-20-light">m52506-0003</span>
                                    </h1>
                                    <div className="precio-disponibilidad text-black-lg-white position-relative mb-10">
                                    ...
                                    <div className="info-detailed">
                                        <div className="social-links-rolex">
                                            ...
                                            <a
                                                className="social-link button-label"
                                                href="https://www.glauser.com.co/rolex/contactenos/"
                                        ...
                                        <div className="swiper-slide">
                                            <div className="swiper-slider">
                                                <picture className="rlx-pbanner-top p-relative">
                                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-drp-upright-bba-with-shadow-portrait.webp" />
                                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-drp-upright-bba-with-shadow-landscape.webp" loading="lazy" alt="Rolex 1908 m52506-0003 reloj" />
                                                </picture>
                                            </div>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-gallery1-landscape.webp" loading="lazy" alt="Rolex 1908 m52506-0003 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-gallery2-landscape.webp" loading="lazy" alt="Rolex 1908 m52506-0003 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-gallery3-landscape.webp" loading="lazy" alt="Rolex 1908 m52506-0003 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-gallery4-landscape.webp" loading="lazy" alt="Rolex 1908 m52506-0003 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        ...
                        <div id="lightbox" className="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img id="lightbox-image" src="" alt="m52506-0003 reloj galeria" />
                                    ...
                                    <div className="accordion-item">
                                        ...
                                        <div className="accordion-content pb-30">
                                            <p className="body-20-light">La garantía de cinco años que se aplica a todos los modelos Rolex viene
                                                acompañada de un sello verde, un símbolo de su estatus de Cronómetro Superlativo. Esta exclusiva
                                                certificación da fe de que el reloj ha superado con éxito una serie de controles finales específicos
                                                llevados a cabo por Rolex en sus propios laboratorios y según sus propios criterios, como complemento de
                                    ...
                                    <div className="accordion-item">
                                        ...
                                        <div className="accordion-content pb-30">
                                            <p className="body-20-light">Todos los relojes Rolex se entregan en un precioso estuche verde que protege y
                                                ...
                                                destinatario esté a la altura de su contenido.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">52506</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Modelo caja</span>
                                            <span className="body-20-light">39 mm, platino, acabado pulido</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Hermetecidad</span>
                                            <span className="body-20-light">Hermético hasta 50 metros/ 165 pies</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Bisel</span>
                                            <span className="body-20-light">Abombado</span>
                                        </li>
                                ...
                                <div className="col-3-5-3-2">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">39 mm</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Brazalete</span>
                                            <span className="body-20-light">Correa de piel</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Movimiento</span>
                                            <span className="body-20-light">Perpetual, mecánico, de cuerda automática</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Calibre</span>
                                            <span className="body-20-light">7140, Manufactura Rolex</span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Azul glaciar, motivo «grano de arroz»</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Reserva de marcha</span>
                                            <span className="body-20-light">Aproximadamente 66 horas</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Certificación</span>
                                            <span className="body-20-light">Cronómetro superlativo (COSC + certificación Rolex tras el encajado)</span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-6-12-7 border-top-brown p-relative" style={{ marginTop: "30px" }}>
                                    <div className="p-absolutes">
                                        <a href="https://assets.rolex.com/api/brochure/es/1908/m52506-0003.pdf" target="_blank" className="btn-primary-icon-rlx">
                            ...
                            <div className="col-6-6-5-3 order-1-mob" style={{ display: "none", }}>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-cor-specs-portrait.webp" />
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-cor-specs-landscape.webp" loading="lazy" alt="Rolex 1908 m52506-0003 especificaciones" />
                                </picture>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <p className="headline50 c-brown-text pb-20">Esfera azul glaciar</p>
                                <p className="body-20-light pb-30">La esfera azul glaciar presenta un motivo «grano de arroz» guilloqueado. Realizada mediante guilloqueado, esta decoración, que recuerda a un rosetón, presenta unos motivos geométricos tridimensionales que se repiten por toda la superficie de la esfera partiendo del contador de segundos situado en la posición de las 6 h. En el contorno de la esfera, la minutería se encuentra enmarcada a ambos lados por un filete con superficie en relieve y motivo «cremallera», también guilloqueado. Con la presentación de una esfera decorada mediante guilloqueado —técnica en la que se talla un motivo en una superficie con un buril—, Rolex hace honor al objetivo que persigue con la colección Perpetual: rendir homenaje al arte clásico de la relojería aplicando al mismo tiempo su savoir-faire y su creatividad. Esta exclusiva esfera presenta los mismos números arábigos 3, 9 y 12 e índices facetados y las mismas agujas que las versiones en oro de 18 quilates.</p>
                                <p className="body-20-light">Este color de esfera exclusivo solamente se encuentra en el Day-Date, el Cosmograph Daytona y el Perpetual 1908.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m52506-0003-dial-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m52506-0003-dial-landscape.webp" loading="lazy" alt="Rolex 1908 m52506-0003 esfera" />
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">Bisel abombado y estriado</p>
                                <p className="body-20-light">Este reloj elegante y sobrio luce una fina caja coronada por un bisel abombado y, a la vez, sutilmente estriado: su parte inferior está delicadamente estriada y su parte superior, abombada.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m52506-0003-bezel-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m52506-0003-bezel-landscape.webp" loading="lazy" alt="Rolex 1908 m52506-0003 bisel" />
                                    </picture>
                                </div>
                                <div className="pb-90-60">
                                    <p className="headline50 c-brown-text pb-20">Platino</p>
                                    <p className="body-20-light">Escaso y precioso, el platino sorprende por su blancura plateada y su vibrante luminosidad. Es uno de los metales más densos y más pesados del mundo, y se distingue por propiedades químicas y físicas únicas, como su excepcional resistencia a la corrosión. Paradójicamente, también es elástico y sumamente maleable, por lo que su manufactura y pulido son especialmente difíciles y exigen una gran habilidad. Rolex emplea platino 950, una aleación compuesta por 950‰ (milésimas) de platino, meticulosamente preparada en nuestros talleres por los excelentes artesanos metalúrgicos de Rolex. El más noble de los metales para el más prestigioso de los relojes.</p>
                                </div>
                            </div>
                        </div>
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m52506-0003-material-portrait.webp" />
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m52506-0003-material-landscape.webp" loading="lazy" alt="Rolex 1908 m52506-0003 material" />
                                </picture>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            ...
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex 1908 m52506-0003 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52506-0003-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
                ...
                <section className="c-lightbeige-bg">
                    <div className="rlx-container-content py-90-60">
                            ...
                            <div className="col-6-12">
                                <a href="http://localhost:3000/rolex/watches/1908/">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-banners/rolex-collection-banner-1908-m52508-0008-portrait.webp"
                                        />
                                        <img
                                            alt="Colección Rolex 1908"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-banners/rolex-collection-banner-1908-m52508-0008-landscape.webp"
                                        />
                                    </picture>
                                </a>
                            </div>
                        ...
                        <div className="row-grid-fullw component-2-col">
                            <div className="col-lg-2-6">
                                <div className="pt-10">
                                    <p className="fixed-16 c-brown-text">Rolex 1908</p>
                                    <p className="headline36 c-brown-text">Clasicismo de vanguardia</p>
                                    <a
                                        className="btn-label-icon-rlx"
                                        href="http://localhost:3000/rolex/watches/1908/">
                                        Más información
                                        <svg
                                            aria-hidden="true"
                                            fill="white"
