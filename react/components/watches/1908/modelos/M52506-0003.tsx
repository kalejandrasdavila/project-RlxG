    ...
    return (
        <>
            <Helmet>
                ...
                <link rel="canonical" href="https://glauser.myvtex.com/rolex/watches/1908/m52506-0003/" />
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://glauser.myvtex.com/rolex/watches/1908/m52506-0003/">m52506-0003
                                        </a>
                                    </li>
                                </ul>
                            </div>
