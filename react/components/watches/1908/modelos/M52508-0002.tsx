...
const M525080002: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex 1908 de 39 mm, oro amarillo de 18 quilates, acabado pulido, m52508-0002 - GLAUSER</title>
                <meta
                    name="description"
                ...
                <link rel="canonical" href="http://localhost:3000/rolex/watches/1908/m52508-0002/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://www.glauser.com.co/rolex/watches/1908/m52508-0002/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex 1908 de 39 mm, oro amarillo de 18 quilates, acabado pulido, m52508-0002 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://www.glauser.com.co/rolex/watches/1908/m52508-0002/" />
                <meta
                    name="twitter:title"
                    content="Rolex 1908 de 39 mm, oro amarillo de 18 quilates, acabado pulido, m52508-0002 - GLAUSER"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://www.glauser.com.co/rolex/watches/1908/m52508-0002/#webpage",
                                "url": "https://www.glauser.com.co/rolex/watches/1908/m52508-0002/",
                                "name": "Rolex 1908 de 39 mm, oro amarillo de 18 quilates, acabado pulido, m52508-0002 - GLAUSER",
                                ...
                                "breadcrumb": { "@id": "https://www.glauser.com.co/rolex/watches/1908/m52508-0002/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://www.glauser.com.co/rolex/watches/1908/m52508-0002/"] }]
                            }
                        ]
                   `}
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "name": "1908",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex 1908 de 39 mm, oro amarillo de 18 quilates, acabado pulido en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m52508-0002",
                        "mpn": "5250",
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="http://localhost:3000/rolex/watches/1908/m52508-0002/">m52508-0002
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="col-6-4-3 pb-90-60">
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light">m52508-0002</span>
                                    </h1>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="swiper-slider">
                                                <picture className="rlx-pbanner-top p-relative">
                                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-drp-upright-bba-with-shadow-portrait.webp" />
                                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-drp-upright-bba-with-shadow-landscape.webp" loading="lazy" alt="Rolex 1908 m52508-0002 reloj" />
                                                </picture>
                                            </div>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-gallery1-landscape.webp" loading="lazy" alt="Rolex 1908 m52508-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-gallery2-landscape.webp" loading="lazy" alt="Rolex 1908 m52508-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-gallery3-landscape.webp" loading="lazy" alt="Rolex 1908 m52508-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-gallery4-landscape.webp" loading="lazy" alt="Rolex 1908 m52508-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        ...
                        <div id="lightbox" className="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img id="lightbox-image" src="" alt="m52508-0002 reloj galeria" />
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                            <div className="row-grid-6-12-7 pt-90-60 cuerpotextobeigebg">
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">39 mm, oro amarillo de 18 quilates, acabado pulido</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-6-12-7 border-top-brown p-relative" style={{ marginTop: "30px" }}>
                                    <div className="p-absolutes">
                                        <a href="https://assets.rolex.com/api/brochure/es/1908/m52508-0002.pdf" target="_blank" className="btn-primary-icon-rlx">
                            ...
                            <div className="col-6-6-5-3 order-1-mob" style={{ display: "none" }}>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-cor-specs-portrait.webp" />
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-cor-specs-landscape.webp" loading="lazy" alt="Rolex 1908 m52508-0002 especificaciones" />
                                </picture>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">Cada esfera supone una pequeña obra de arte. El color, los reflejos, la textura de su superficie, así como los elementos que la decoran o incluso el diseño del conjunto, le confieren al reloj toda su personalidad. Rolex lleva a cabo de forma interna la totalidad del proceso de creación y fabricación de sus esferas. Se trata de una serie de gestos y operaciones que, desde los primeros esbozos hasta el control final, pasando por las etapas de coloración y colocación de los indicadores, requieren a profesionales especializados. Algunas de estas profesiones se remontan a los orígenes de la relojería, como, por ejemplo, el esmaltador. Otras son inherentes al uso de tecnologías punta, como el tratamiento de superficies por pulverización catódica magnetrón que consiste en colorear la superficie de la esfera mediante el depósito de una ínfima capa de material, un complejo procedimiento que se realiza al vacío. La fabricación de las esferas Rolex, una labor tan artesanal como tecnológica, resume perfectamente la filosofía que mueve a la marca: alcanzar el más alto nivel de calidad para lograr un resultado impecable y permanente.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m52508-0002-dial-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m52508-0002-dial-landscape.webp" loading="lazy" alt="Rolex 1908 m52508-0002 esfera" />
                                    </picture>
                                </div>
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m52508-0002-bezel-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m52508-0002-bezel-landscape.webp" loading="lazy" alt="Rolex 1908 m52508-0002 bisel" />
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m52508-0002-material-portrait.webp" />
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m52508-0002-material-landscape.webp" loading="lazy" alt="Rolex 1908 m52508-0002 material" />
                                </picture>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            ...
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex 1908 m52508-0002 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m52508-0002-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
