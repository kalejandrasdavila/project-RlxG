...
const OysterP: React.FC = () => {
    ...
    useWatchCollectionMeta({
        title: 'Relojes Rolex Oyster Perpetual - GLAUSER',
        description: 'Descubra los relojes Rolex Oyster Perpetual en línea en GLAUSER, Distribuidor Oficial autorizado para vender relojes Rolex para hombre y para mujer. Descubra más en GLAUSER.',
        canonicalUrl: 'https://glauser.myvtex.com/rolex/watches/oyster-perpetual/',
        ogImage: 'https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-banners/rolex-collection-banner-oyster-perpetual-m124300-0001-portrait.webp',
