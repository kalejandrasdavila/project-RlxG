                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">
                                    ...
                                    de la colecci�n Oyster Perpetual. Se obtiene utilizando t�cnicas
                                    ...
                                    creando un sutil brillo caracter�stico que se mueve seg�n la posici�n
                                    de la mu�eca. Una vez completado el acabado tipo sol, el color de la
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        ...
                                        />
                                        <img
                                            alt="Rolex Oyster Perpetual m276200-0001 caja presentaci�n"
                                            loading="lazy"
