...
const M228348rbr0002: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Day-Date 40 de Oyster, 40 mm, oro amarillo y diamantes, m228348rbr-0002 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Day-Date 40 de Oyster, 40 mm, oro amarillo y diamantes en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m228348rbr-0002/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m228348rbr-0002/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Day-Date 40 de Oyster, 40 mm, oro amarillo y diamantes, m228348rbr-0002 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m228348rbr-0002/" />
                <meta
                    name="twitter:title"
                    content="Rolex Day-Date 40 de Oyster, 40 mm, oro amarillo y diamantes, m228348rbr-0002 - GLAUSER"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m228348rbr-0002/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m228348rbr-0002/",
                                "name": "Rolex Day-Date 40 de Oyster, 40 mm, oro amarillo y diamantes, m228348rbr-0002 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Day-Date 40 de Oyster, 40 mm, oro amarillo y diamantes en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m228348rbr-0002/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m228348rbr-0002/"] }]
                            }
                        ]
                   `}
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "name": "Day-Date 40",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Day-Date 40 de Oyster, 40 mm, oro amarillo y diamantes en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m228348rbr-0002",
                        "mpn": "228348RBR",
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14">
                                        <a href="https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/">
                                            Day-Date
                                        </a>
                                    </li>
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m228348rbr-0002/">m228348rbr-0002
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light block block">
                                            Oyster, 40 mm, oro amarillo y diamantes
                                        </span>
                                        <span className="body-20-light">m228348rbr-0002</span>
                                    </h1>
                            ...
                            <div className="col-6-6-4 order-1-mob">
                                <div className="swiper swiper-container-mobile">
                                    <div className="swiper-wrapper">
                                        ...
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery1-landscape.webp" loading="lazy" alt="Rolex Day-Date m228348rbr-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery2-landscape.webp" loading="lazy" alt="Rolex Day-Date m228348rbr-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery3-landscape.webp" loading="lazy" alt="Rolex Day-Date m228348rbr-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery4-landscape.webp" loading="lazy" alt="Rolex Day-Date m228348rbr-0002 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw galeria-models">
                            <div className="span-3-1">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        ...
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery1-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m228348rbr-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery1-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-2">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery2-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m228348rbr-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery2-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-3">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery3-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m228348rbr-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery3-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-4">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery4-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m228348rbr-0002 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-gallery4-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        <div className="lightbox" id="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img alt="m228348rbr-0002 reloj galeria" id="lightbox-image" src="" />
                        ...
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">228348RBR</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-3-5-3-2">
                                    <ul className="list-especification-model-rlx ">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">
                                                President, eslabones de tres elementos semicirculares
                                            </span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">3255, Manufactura Rolex</span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">
                                                Color champagne, engastada de diamantes
                                            </span>
                                        </li>
                                        <li>
                                ...
                                <div
                                    ...
                                    <div className="p-absolutes">
                                        <a
                                            ...
                                            href="https://assets.rolex.com/api/brochure/es/day-date/m228348rbr-0002.pdf"
                                            target="_blank">
                                            <svg
                            ...
                            <div
                                ...
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-cor-specs-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m228348rbr-0002 especificaciones"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-cor-specs-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">
                                    Esta esfera presenta 10 diamantes talla «baguette». El acabado tipo
                                    sol crea delicados reflejos de luz en muchas esferas de la colección
                                    Oyster Perpetual. Se obtiene utilizando técnicas magistrales de
                                    cepillado que crean surcos que salen del centro de la esfera. La luz
                                    se difunde constantemente a lo largo de cada grabado, creando un sutil
                                    brillo característico que se mueve según la posición de la muñeca. Una
                                    vez completado el acabado tipo sol, el color de la esfera se aplica
                                    mediante PVD (Physical Vapour Deposition) o galvanoplastia. Una ligera
                                    capa de barniz le da a la esfera su aspecto final.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m228348rbr-0002-dial-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Day-Date m228348rbr-0002 esfera"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m228348rbr-0002-dial-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                ...
                                <p className="body-20-light">
                                    ...
                                    preciosos para preparar el espacio donde alojarán perfectamente cada
                                    ...
                                    engaste de piedras de Rolex: la alineación precisa del tamaño de las
                                    piedras, su orientación y posición, la regularidad, la solidez y las
                                    proporciones del engaste, así como el acabado del trabajo en metal.
                                    Una combinación mágica de luces que embellece el reloj y hechiza a
                                    quien lo lleva.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m228348rbr-0002-bezel-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Day-Date m228348rbr-0002 bisel"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m228348rbr-0002-bezel-landscape.webp"
                                        />
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m228348rbr-0002-material-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m228348rbr-0002 material"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m228348rbr-0002-material-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Day-Date m228348rbr-0002 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228348rbr-0002-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
