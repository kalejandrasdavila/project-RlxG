...
const M1282360018: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Day-Date 36 de Oyster, 36 mm, platino, m128236-0018 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Day-Date 36 de Oyster, 36 mm, platino en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m128236-0018/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m128236-0018/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Day-Date 36 de Oyster, 36 mm, platino, m128236-0018 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m128236-0018/" />
                <meta
                    name="twitter:title"
                    content="Rolex Day-Date 36 de Oyster, 36 mm, platino, m128236-0018 - GLAUSER"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m128236-0018/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m128236-0018/",
                                "name": "Rolex Day-Date 36 de Oyster, 36 mm, platino, m128236-0018 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Day-Date 36 de Oyster, 36 mm, platino en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m128236-0018/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m128236-0018/"] }]
                            }
                        ]
                   `}
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "name": "Day-Date 36",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Day-Date 36 de Oyster, 36 mm, platino en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m128236-0018",
                        "mpn": "128236",
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m128236-0018/">m128236-0018
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light block block">
                                            Oyster, 36 mm, platino
                                        </span>
                                        <span className="body-20-light">m128236-0018</span>
                                    </h1>
                            ...
                            <div className="col-6-6-4 order-1-mob">
                                <div className="swiper swiper-container-mobile">
                                    <div className="swiper-wrapper">
                                        ...
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery1-landscape.webp" loading="lazy" alt="Rolex Day-Date m128236-0018 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery2-landscape.webp" loading="lazy" alt="Rolex Day-Date m128236-0018 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery3-landscape.webp" loading="lazy" alt="Rolex Day-Date m128236-0018 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery4-landscape.webp" loading="lazy" alt="Rolex Day-Date m128236-0018 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw galeria-models">
                            <div className="span-3-1">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        ...
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery1-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m128236-0018 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery1-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-2">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery2-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m128236-0018 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery2-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-3">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery3-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m128236-0018 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery3-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-4">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery4-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m128236-0018 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-gallery4-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        <div className="lightbox" id="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img alt="m128236-0018 reloj galeria" id="lightbox-image" src="" />
                        ...
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">128236</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Modelo caja</span>
                                            <span className="body-20-light">Oyster, 36 mm, platino</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Azul glaciar</span>
                                        </li>
                                        <li>
                                ...
                                <div
                                    ...
                                    <div className="p-absolutes">
                                        <a
                                            ...
                                            href="https://assets.rolex.com/api/brochure/es/day-date/m128236-0018.pdf"
                                            target="_blank">
                                            <svg
                            ...
                            <div
                                ...
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-cor-specs-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m128236-0018 especificaciones"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-cor-specs-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">
                                    ...
                                    platino en este Day-Date 36.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m128236-0018-bezel-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Day-Date m128236-0018 bisel"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m128236-0018-bezel-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">Esfera azul glaciar</p>
                                <p className="body-20-light">
                                    La esfera azul glaciar es una firma exclusiva y discreta de un reloj
                                    Rolex de platino. Rolex utiliza platino, el más noble de los metales
                                    para el más prestigioso de los relojes. Este color de esfera exclusivo
                                    solamente se encuentra en el Day-Date, el Cosmograph Daytona y el
                                    Perpetual 1908.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m128236-0018-dial-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Day-Date m128236-0018 esfera"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m128236-0018-dial-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">
                                        Escaso y precioso, el platino sorprende por su blancura plateada y
                                        su vibrante luminosidad. Es uno de los metales más densos y más
                                        pesados del mundo, y se distingue por propiedades químicas y físicas
                                        únicas, como su excepcional resistencia a la corrosión.
                                        Paradójicamente, también es elástico y sumamente maleable, por lo
                                        que su manufactura y pulido son especialmente difíciles y exigen una
                                        gran habilidad. Rolex emplea platino 950, una aleación compuesta por
                                        950‰ (milésimas) de platino, meticulosamente preparada en nuestros
                                        talleres por los excelentes artesanos metalúrgicos de Rolex. El más
                                        noble de los metales para el más prestigioso de los relojes.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m128236-0018-material-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m128236-0018 material"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m128236-0018-material-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Day-Date m128236-0018 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128236-0018-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
