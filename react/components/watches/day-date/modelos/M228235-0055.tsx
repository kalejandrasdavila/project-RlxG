                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">
                                    ...
                                    esfera de color pizarra sombreado. Se trata de una esfera inídita
                                    tanto por la tonalidad, pues el color del centro se va oscureciendo
                                    hasta llegar al negro en el contorno, como por los nímeros romanos
                                    ...
                                    la marca en la dícada de 1980 y relanzado en 2019. Para fabricar estas
                                    esferas con dígradí concíntrico es preciso aplicar una laca negra, una
                                    operación delicada supervisada por un especialista que se asegura de
                                    que la transiciín del color a la oscuridad resulte armoniosa.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
