...
const M2282350055: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Day-Date 40 de Oyster, 40 mm, oro Everose, m228235-0055 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Day-Date 40 de Oyster, 40 mm, oro Everose en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m128239-0063/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m128239-0063/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Day-Date 40 de Oyster, 40 mm, oro Everose, m228235-0055 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m128239-0063/" />
                <meta
                    name="twitter:title"
                    content="Rolex Day-Date 40 de Oyster, 40 mm, oro Everose, m228235-0055 - GLAUSER"
                />
                ...
                <meta
                    name="twitter:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m128239-0063-drp-upright-bba-with-shadow-landscape.webp"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m228235-0055/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m228235-0055/",
                                "name": "Rolex Day-Date 40 de Oyster, 40 mm, oro Everose, m228235-0055 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Day-Date 40 de Oyster, 40 mm, oro Everose en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m228235-0055/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m228235-0055/"] }]
                            }
                        ]
                   `}
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "name": "Day-Date 40",
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Day-Date 40 de Oyster, 40 mm, oro Everose en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m228235-0055",
                        "mpn": "228235",
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/day-date/m228235-0055/">m228235-0055
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="col-6-4-3 pb-90-60">
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light">m228235-0055</span>
                                    </h1>
                            ...
                            <div className="col-6-6-4 order-1-mob">
                                <div className="swiper swiper-container-mobile">
                                    <div className="swiper-wrapper">
                                        ...
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery1-landscape.webp" loading="lazy" alt="Rolex Day-Date m228235-0055 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery2-landscape.webp" loading="lazy" alt="Rolex Day-Date m228235-0055 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery3-landscape.webp" loading="lazy" alt="Rolex Day-Date m228235-0055 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery4-landscape.webp" loading="lazy" alt="Rolex Day-Date m228235-0055 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw galeria-models">
                            <div className="span-3-1">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        ...
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery1-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m228235-0055 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery1-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-2">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery2-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m228235-0055 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery2-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-3">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery3-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m228235-0055 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery3-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-4">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery4-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m228235-0055 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-gallery4-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        <div className="lightbox" id="lightbox">
                            ...
                            <div className="lightbox-content">
                                ...
                                <img alt="m228235-0055 reloj galeria" id="lightbox-image" src="" />
                        ...
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">228235</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Pizarra sombreado</span>
                                        </li>
                                        <li>
                                ...
                                <div
                                    ...
                                    <div className="p-absolutes">
                                        <a
                                            ...
                                            href="https://assets.rolex.com/api/brochure/es/day-date/m228235-0055.pdf"
                                            target="_blank">
                                            <svg
                            ...
                            <div
                                ...
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-cor-specs-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m228235-0055 especificaciones"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-cor-specs-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">
                                    El bisel estriado de Rolex es una marca de distinción. En un
                                    ...
                                    hermeticidad del reloj. Además, era idéntico al acanalado del fondo de
                                    la caja, atornillado a ésta por la misma razón, mediante herramientas
                                    específicas de Rolex. Con el tiempo, el estriado se convirtió en un
                                    elemento puramente estético, una auténtica característica distintiva
                                    de Rolex. En la actualidad, el estriado es una marca de distinción, en
                                    oro en este DayDate 40.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m228235-0055-bezel-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Day-Date m228235-0055 bisel"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m228235-0055-bezel-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">
                                    Esfera en color pizarra sombreado
                                </p>
                                <p className="body-20-light">
                                    La modalidad fabricada en oro Everose de 18 quilates presenta una
                                    esfera de color pizarra sombreado. Se trata de una esfera inédita
                                    tanto por la tonalidad, pues el color del centro se va oscureciendo
                                    hasta llegar al negro en el contorno, como por los números romanos
                                    independientes facetados y los índices facetados en oro rosa de 18
                                    quilates. Hasta ahora, las esferas sombreadas de Rolex eran exclusivas
                                    del Day-Date 36 y lucían unos marcadores de horas engastados de
                                    diamantes. Esta nueva esfera da continuidad a un diseño presentado por
                                    la marca en la década de 1980 y relanzado en 2019. Para fabricar estas
                                    esferas con dégradé concéntrico es preciso aplicar una laca negra, una
                                    operación delicada supervisada por un especialista que se asegura de
                                    que la transición del color a la oscuridad resulte armoniosa.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m228235-0055-dial-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Day-Date m228235-0055 esfera"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m228235-0055-dial-landscape.webp"
                                        />
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m228235-0055-material-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Day-Date m228235-0055 material"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m228235-0055-material-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Day-Date m228235-0055 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m228235-0055-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
