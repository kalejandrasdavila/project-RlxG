                                ...
                                <div className="col-3-5-3-2">
                                    <ul className="list-especification-model-rlx ">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">
                                                Perpetual, cronígrafo mecúnico, de cuerda automática
                                            </span>
                                        </li>
                                        <li>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light pb-30">Este es el único modelo Cosmograph Daytonaícon esfera meteorito. El meteorito proviene del corazín de un asteroide ío puede que incluso un planetaí que ha explotado, impulsando material por todo el sistema solar hasta que entra en la írbita de nuestro planeta y la gravedad lo empuja hasta la tierra.</p>
                                <p className="body-20-light">Durante su viaje, el centro del meteorito se va transformando gradualmente, produciendo patrones metílicos muy inusuales como resultado del enfriamiento lento de los nícleos de asteroide derretidos. Los diseñadores de Rolex crean, a partir de esas configuraciones, un tesoro único para algunos de los modelos más prestigiosos, incluyendo este Cosmograph Daytona.</p>
                                ...
                                <p className="headline50 c-brown-text pb-20">La escala taquimítrica</p>
                                <p className="body-20-light pb-30">Un elemento clave de la identidad del modelo, su bisel moldeado con una escala taquimítrica, permite medir una velocidad media de hasta 400ímillas o kilímetros por hora. Combinando alta tecnología con una estética de categoría, el bisel negro recuerda al del modelo deí1965 provisto de un bisel también negro, pero con disco de plexiglís.</p>
                                <p className="body-20-light">El bisel monobloque Cerachrom de cerámica de alta tecnología ofrece numerosas ventajas: su dureza lo convierte en prácticamente imposible de rayar, conserva su color a pesar de los efectos de los rayos UV y permanece inmune a la corrosiín. Una extrema durabilidad a la que se suma una legibilidad extraordinaria de la escala taquimítrica, cuya graduaciín es obtenida depositando en las incisiones una fina capa de platino mediante tícnica PVD (Physical Vapour Deposition). El bisel monobloque Cerachrom consta de una sola pieza y garantiza por sí mismo el mantenimiento de la hermeticidad del cristal sobre la carrura.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                ...
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">
                                        El nuevo CosmographíDaytona está provisto de un brazaleteíOysterflex,
                                        desarrollado y patentado por Rolex. Su interior está compuesto por una
                                        límina metílica superelística sobremoldeada con elastímero negro de
                                        ...
                                        seguridadíOysterlock y cuenta además con el sistema de extensiín
                                        rípida Easylink, patentado por Rolex, que permite ajustar fícilmente
                                        su longitud en 5ímm aproximadamente, con el fin de ofrecer una
                                        comodidad íptima en todas las situaciones.
                                    </p>
                                </div>
                            </div>
                        </div>
