...
const M126518ln0016: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Cosmograph Daytona de Oyster, 40 mm, oro amarillo, m126518ln-0016 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Cosmograph Daytona de Oyster, Oyster, 40 mm, oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126518ln-0016/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126518ln-0016/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Cosmograph Daytona de Oyster, 40 mm, oro amarillo, m126518ln-0016 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126518ln-0016/" />
                <meta
                    name="twitter:title"
                    content="Rolex Cosmograph Daytona de Oyster, 40 mm, oro amarillo, m126518ln-0016 - GLAUSER"
                />
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126518ln-0016/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126518ln-0016/",
                                "name": "Rolex Cosmograph Daytona de Oyster, 40 mm, oro amarillo, m126518ln-0016 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Cosmograph Daytona de Oyster, Oyster, 40 mm, oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126518ln-0016/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126518ln-0016/"] }]
                            }
                        ]
                    `}
                ...
                <script type="application/ld+json">
                    {`
                        ...
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Cosmograph Daytona de Oyster, Oyster, 40 mm, oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m126518ln-0016",
                        "mpn": "126518LN",
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14">
                                        <a href="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/">
                                            Cosmograph-Daytona
                                        </a>
                                    </li>
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126518ln-0016/">m126518ln-0016
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="col-6-4-3 pb-90-60">
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light">m126518ln-0016</span>
                                    </h1>
                                    ...
                                    <div className="info-detailed">
                                        <div className="social-links-rolex">
                                            ...
                                            <a
                                                ...
                                                <span className="text-mapita">Encuéntranos</span>
                                            </a>
                                        </div>
                                    </div>
                                    <a
                                        ...
                                        <div className="swiper-slide">
                                            <div className="swiper-slider">
                                                <picture className="rlx-pbanner-top p-relative">
                                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-drp-upright-bba-with-shadow-portrait.webp" />
                                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-drp-upright-bba-with-shadow-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126518ln-0016 reloj" />
                                                </picture>
                                            </div>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery1-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery1-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126518ln-0016 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery2-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery2-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126518ln-0016 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery3-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery3-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126518ln-0016 reloj galeria" />
                                            </picture>
                                        </div>
                                        <div className="swiper-slide">
                                            <picture className="rlx-pbanner-top p-relative">
                                                <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery4-portrait.webp" />
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery4-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126518ln-0016 reloj galeria" />
                                            </picture>
                                        </div>
                                    </div>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw galeria-models">
                            <div className="span-3-1">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        ...
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery1-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Cosmograph Daytona m126518ln-0016 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery1-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-2">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery2-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Cosmograph Daytona m126518ln-0016 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery2-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-3">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery3-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Cosmograph Daytona m126518ln-0016 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery3-landscape.webp"
                                    />
                                </picture>
                            </div>
                            <div className="span-3-4">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery4-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Cosmograph Daytona m126518ln-0016 reloj galeria"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-gallery4-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                        <div className="lightbox" id="lightbox">
                            ...
                            <div className="lightbox-content">
                                <button className="nav-button prev-button" id="prev-button">
                                    {`<`}
                                </button>
                                <img alt="m52506-0002 reloj galeria" id="lightbox-image" src="" />
                                <button className="nav-button next-button" id="next-button">
                                    {`>`}
                                </button>
                            </div>
                                    ...
                                    <div className="accordion-item">
                                        ...
                                        <div className="accordion-content pb-30">
                                            <p className="body-20-light">
                                                ...
                                                lo primero que vea el destinatario esté a la altura de su
                                                contenido.
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                            <div className="row-grid-6-12-7 pt-90-60 cuerpotextobeigebg">
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">126518LN</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Modelo caja</span>
                                            <span className="body-20-light">Oyster, 40 mm, oro amarillo</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Hermetecidad</span>
                                            <span className="body-20-light">
                                                Hermético hasta 100 metros/ 330 pies
                                            </span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Bisel</span>
                                            <span className="body-20-light">
                                                Bisel Cerachrom monobloque en cerámica negra con escala
                                                taquimétrica moldeada
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-3-5-3-2">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            <span className="body-20-bold block">Diámetro</span>
                                            <span className="body-20-light">40 mm</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Brazalete</span>
                                            <span className="body-20-light">Oysterflex</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Movimiento</span>
                                            <span className="body-20-light">
                                                Perpetual, cronógrafo mecánico, de cuerda automática
                                            </span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Calibre</span>
                                            <span className="body-20-light">4131, Manufactura Rolex</span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Meteorito y negra</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <span className="body-20-bold block">Certificación</span>
                                            <span className="body-20-light">
                                                Cronómetro superlativo (COSC + certificación Rolex tras el
                                                ensamblaje)
                                            </span>
                                        </li>
                                    </ul>
                                ...
                                <div
                                    className="col-6-12-7 border-top-brown p-relative"
                                    style={{
                                        marginTop: "30px",
                                    }}>
                                    <div className="p-absolutes">
                                        <a
                                            ...
                                            href="https://assets.rolex.com/api/brochure/es/cosmograph-daytona/m126518ln-0016.pdf"
                                            target="_blank">
                                            <svg
                                                ...
                                                width="12"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M15,10v5h-1h-1H2H0v-2v-3h2v3h11v-3H15z M5.5,9.5l2,2l2-2l2-2h-3V0H8H7H6.5v7.5h-3L5.5,9.5z" />
                                            </svg>
                                            Descargar brochure
                                        </a>
                                    </div>
                            ...
                            <div
                                className="col-6-6-5-3 order-1-mob"
                                style={{
                                    display: "none",
                                }}>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-cor-specs-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Cosmograph Daytona m126518ln-0016 especificaciones"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-cor-specs-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <p className="headline50 c-brown-text pb-20">Esfera meteorito</p>
                                <p className="body-20-light pb-30">Este es el único modelo Cosmograph Daytona con esfera meteorito. El meteorito proviene del corazón de un asteroide —o puede que incluso un planeta— que ha explotado, impulsando material por todo el sistema solar hasta que entra en la órbita de nuestro planeta y la gravedad lo empuja hasta la tierra.</p>
                                <p className="body-20-light">Durante su viaje, el centro del meteorito se va transformando gradualmente, produciendo patrones metálicos muy inusuales como resultado del enfriamiento lento de los núcleos de asteroide derretidos. Los diseñadores de Rolex crean, a partir de esas configuraciones, un tesoro único para algunos de los modelos más prestigiosos, incluyendo este Cosmograph Daytona.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126518ln-0016-dial-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Cosmograph Daytona m126518ln-0016 esfera"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126518ln-0016-dial-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">La escala taquimétrica</p>
                                <p className="body-20-light pb-30">Un elemento clave de la identidad del modelo, su bisel moldeado con una escala taquimétrica, permite medir una velocidad media de hasta 400 millas o kilómetros por hora. Combinando alta tecnología con una estética de categoría, el bisel negro recuerda al del modelo de 1965 provisto de un bisel también negro, pero con disco de plexiglás.</p>
                                <p className="body-20-light">El bisel monobloque Cerachrom de cerámica de alta tecnología ofrece numerosas ventajas: su dureza lo convierte en prácticamente imposible de rayar, conserva su color a pesar de los efectos de los rayos UV y permanece inmune a la corrosión. Una extrema durabilidad a la que se suma una legibilidad extraordinaria de la escala taquimétrica, cuya graduación es obtenida depositando en las incisiones una fina capa de platino mediante técnica PVD (Physical Vapour Deposition). El bisel monobloque Cerachrom consta de una sola pieza y garantiza por sí mismo el mantenimiento de la hermeticidad del cristal sobre la carrura.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126518ln-0016-bezel-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Cosmograph Daytona m126518ln-0016 bisel"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126518ln-0016-bezel-landscape.webp"
                                        />
                                    </picture>
                                </div>
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">
                                        El nuevo Cosmograph Daytona está provisto de un brazalete Oysterflex,
                                    desarrollado y patentado por Rolex. Su interior está compuesto por una
                                    lámina metálica superelástica sobremoldeada con elastómero negro de
                                    alto rendimiento. Este material posee una gran duración y resiste
                                    particularmente bien a las agresiones ambientales. En su versión
                                    Oysterflex, el brazalete está provisto también de un cierre de
                                    seguridad Oysterlock y cuenta además con el sistema de extensión
                                    rápida Easylink, patentado por Rolex, que permite ajustar fácilmente
                                    su longitud en 5 mm aproximadamente, con el fin de ofrecer una
                                    comodidad óptima en todas las situaciones.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source
                                        media="(max-width: 767px)"
                                        srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126518ln-0016-bracelet-portrait.webp"
                                    />
                                    <img
                                        alt="Rolex Cosmograph Daytona m126518ln-0016 material"
                                        loading="lazy"
                                        src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126518ln-0016-bracelet-landscape.webp"
                                    />
                                </picture>
                            </div>
                        </div>
                            ...
                            <div className="row-grid-fullw cuerpotextobg">
                                <div className="col-text-center">
                                    <div className="py-90-60">
                                        ...
                                        <div className="px-20 text-center">
                                            ...
                                            <p className="body-20-light pb-30">
                                                ...
                                                tan altos limitan naturalmente la capacidad de producción de
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            media="(max-width: 767px)"
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Cosmograph Daytona m126518ln-0016 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126518ln-0016-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
