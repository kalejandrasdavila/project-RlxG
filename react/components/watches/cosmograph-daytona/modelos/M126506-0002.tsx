                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">Bisel Cerachrom monobloque marrón de cerámica con nímeros y graduaciones moldeados</span>
                                        </li>
                                    </ul>
                                </div>
