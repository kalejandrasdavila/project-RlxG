...
const M1265030003: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Cosmograph Daytona de Oyster, 40 mm, acero Oystersteel y oro amarillo, m126503-0003 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Cosmograph Daytona de Oyster, 40 mm, oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126503-0003/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126503-0003/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Cosmograph Daytona de Oyster, 40 mm, acero Oystersteel y oro amarillo, m126503-0003 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126503-0003/" />
                <meta
                    name="twitter:title"
                    content="Rolex Cosmograph Daytona de Oyster, 40 mm, acero Oystersteel y oro amarillo, m126503-0003 - GLAUSER"
                />
                ...
                {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126503-0003/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126503-0003/",
                                "name": "Rolex Cosmograph Daytona de Oyster, 40 mm, acero Oystersteel y oro amarillo, m126503-0003 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Cosmograph Daytona de Oyster, 40 mm, oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126503-0003/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126503-0003/"] }]
                            }
                        ]
                    `}
                ...
                {`
                        ...
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Cosmograph Daytona de Oyster, 40 mm, oro amarillo en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m126503-0003",
                        "mpn": "126503",
            ...
            <main id="rlx-html">
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126503-0003/">m126503-0003
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="col-6-4-3 pb-90-60">
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light">m126503-0003</span>
                                    </h1>
                                    <div className="precio-disponibilidad text-black-lg-white postion-relative mb-10">
                                        ...
                                        <div
                                            ...
                                            <p className="body-20-light text-black">
                                                Precio de venta recomendado por Rolex, IVA incluido. Los precios
                                                pueden modificarse en cualquier momento sin previo aviso.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slider">
                                        <picture className="rlx-pbanner-top p-relative">
                                            <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-drp-upright-bba-with-shadow-portrait.webp"/>
                                            <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-drp-upright-bba-with-shadow-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126503-0003 reloj"/>
                                        </picture>
                                    </div>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-gallery1-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-gallery1-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126503-0003 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-gallery2-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-gallery2-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126503-0003 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-gallery3-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-gallery3-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126503-0003 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-gallery4-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-gallery4-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126503-0003 reloj galeria"/>
                                    </picture>
                                    </div>
                                </div>
                ...
                <section className="c-lightbeige-bg d-none-md">
                    ...
                    <div id="lightbox" className="lightbox">
                        ...
                        <div className="lightbox-content">
                            ...
                            <img id="lightbox-image" src="" alt="m126503-0003 reloj galeria"/>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                            <div className="row-grid-6-12-7 pt-90-60 cuerpotextobeigebg">
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">126503</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Modelo caja</span>
                                            <span className="body-20-light">Oyster, 40 mm, acero Oystersteel y oro amarillo</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">Fijo, con escala taquimétrica grabada, en oro amarillo</span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-3-5-3-2">
                                    <ul className="list-especification-model-rlx ">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">Oyster (3 elementos), eslabones macizos</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Negra, anillos de contadores en dorado</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-6-12-7 border-top-brown p-relative" style={{ marginTop: "30px" }}>
                                    <div className="p-absolutes">
                                        <a href="https://assets.rolex.com/api/brochure/es/cosmograph-daytona/m126503-0003.pdf" target="_blank" className="btn-primary-icon-rlx">
                            ...
                            <div className="col-6-6-5-3 order-1-mob"  style={{ display: "none" }}>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-cor-specs-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-cor-specs-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126503-0003 especificaciones"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">Con su escala taquimétrica, sus tres contadores y sus pulsadores, el Cosmograph Daytona se creó para ser la mejor herramienta de cronometraje de los pilotos de resistencia. El bisel presenta una escala taquimétrica que permite leer la velocidad media en una distancia determinada en función del tiempo cronometrado. Esta escala ofrece una legibilidad óptima, lo que convierte el Cosmograph Daytona en el instrumento perfecto para medir la velocidad hasta las 400 unidades por hora, ya se trate de kilómetros o millas.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126503-0003-bezel-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126503-0003-bezel-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126503-0003 bisel"/>
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">Esfera negra</p>
                                <p className="body-20-light">Este modelo presenta una esfera negra con unos índices en aplique de oro de 18 quilates y agujas con visualización Chromalight, un material luminiscente de alta legibilidad. La esfera permite a los pilotos planificar con precisión sus tiempos y tácticas sin ningún tipo de error.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126503-0003-dial-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126503-0003-dial-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126503-0003 esfera"/>
                                    </picture>
                                </div>
                                <div className="pb-90-60">
                                    <p className="headline50 c-brown-text pb-20">Rolesor amarillo</p>
                                    <p className="body-20-light">El oro es codiciado por su lustre y su nobleza. El acero afianza la fuerza y la fiabilidad. Juntos, combinan armoniosamente lo mejor de sus propiedades. Verdadera firma de Rolex, el Rolesor ha sido parte de los modelos Rolex desde principios de los años treinta y fue patentado como nombre en 1933. Es uno de los prominentes pilares de la colección Oyster.</p>
                                </div>
                            </div>
                        </div>
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126503-0003-material-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126503-0003-material-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126503-0003 material"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                ...
                <section id="disponibilidadmodelo" className="c-lightbeige-bg">
                    <div className="rlx-container-content">
                                    ...
                                    <div className="py-90-60">
                                        <div className="pb-40-60">
                                            <picture className="rlxcrown">
                                                <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/logo-plecas/crown-rolex-footer.webp" height="60" width="60" loading="lazy" alt="crown rolex" />
                                            </picture>
                                        </div>
                                        <div className="px-20 text-center">
                                            <p className="headline50 c-brown-text pb-20">Disponibilidad del modelo</p>
                                            <p className="body-20-light pb-30">Todos los relojes Rolex se ensamblan a mano con sumo cuidado para garantizar una Colombiadad excepcional. Unos estándares tan altos limitan naturalmente la capacidad de producción de Rolex y, a veces, la demanda de relojes Rolex supera esta capacidad.</p>
                                            <p className="body-20-light pb-30">Por lo tanto, la disponibilidad de ciertos modelos puede ser limitada. Los relojes Rolex nuevos se venden exclusivamente a través de los Distribuidores Oficiales Rolex, que reciben entregas habituales y gestionan de manera independiente la distribución y las ventas a sus clientes.</p>
                                            <p className="body-20-light">GLAUSER se enorgullece de formar parte de la red mundial de Distribuidores Oficiales Rolex, y puede proporcionar información sobre la disponibilidad de los relojes Rolex.</p>
                                        </div>
                                    </div>
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-presentation-box-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126503-0003-presentation-box-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126503-0003 caja presentación" />
                                    </picture>
                                </div>
                            </div>
                        </div>
