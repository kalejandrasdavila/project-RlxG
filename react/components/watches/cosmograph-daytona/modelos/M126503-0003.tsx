                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">Fijo, con escala taquimítrica grabada, en oro amarillo</span>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">Con su escala taquimítrica, sus tres contadores y sus pulsadores, el Cosmograph Daytona se creí para ser la mejor herramienta de cronometraje de los pilotos de resistencia. El bisel presenta una escala taquimítrica que permite leer la velocidad media en una distancia determinada en función del tiempo cronometrado. Esta escala ofrece una legibilidad íptima, lo que convierte el Cosmograph Daytona en el instrumento perfecto para medir la velocidad hasta las 400 unidades por hora, ya se trate de kilímetros o millas.</p>
                                ...
                                <div className="col-text-center">
                                    <div className="py-90-60">
                                        ...
                                        <div className="px-20 text-center">
                                            ...
                                            <p className="body-20-light pb-30">Todos los relojes Rolex se ensamblan a mano con sumo cuidado para garantizar una Colombiadad excepcional. Unos estándares tan altos limitan naturalmente la capacidad de producciín de Rolex y, a veces, la demanda de relojes Rolex supera esta capacidad.</p>
                                            <p className="body-20-light pb-30">Por lo tanto, la disponibilidad de ciertos modelos puede ser limitada. Los relojes Rolex nuevos se venden exclusivamente a través de los Distribuidores Oficiales Rolex, que reciben entregas habituales y gestionan de manera independiente la distribuciín y las ventas a sus clientes.</p>
