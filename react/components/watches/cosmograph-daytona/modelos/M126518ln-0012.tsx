                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">
                                    Este modelo presenta una esfera dorada y negro vivo con contadores con círculos concíntricos, unos índices en aplique de oro de 18íquilates y agujas con visualización Chromalight, un material luminiscente de alta legibilidad. La esfera permite a los pilotos planificar con precisión sus tiempos y tícticas sin ningín tipo de error.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
