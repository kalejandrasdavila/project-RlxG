                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light pb-30">
                                    Este modelo presenta una esfera color negro intenso y color champagne con contadores pulverizados, índices en aplique de oro de 18íquilates y agujas con visualización Chromalight, un material luminiscente de alta legibilidad.
                                </p>
                                <p className="body-20-light">
