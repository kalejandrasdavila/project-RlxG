...
const M126589rbr0001: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Cosmograph Daytona de Oyster, 40 mm, oro blanco y diamantes, m126589rbr-0001 - GLAUSER</title>
                <meta
                    name="description"
                    content="Descubra el reloj Rolex Cosmograph Daytona de Oyster, 40 mm, oro blanco y diamantes en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex"
                />
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126589rbr-0001/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126589rbr-0001/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Cosmograph Daytona de Oyster, 40 mm, oro blanco y diamantes, m126589rbr-0001 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126589rbr-0001/" />
                <meta
                    name="twitter:title"
                    content="Rolex Cosmograph Daytona de Oyster, 40 mm, oro blanco y diamantes, m126589rbr-0001 - GLAUSER"
                />
                ...
                {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126589rbr-0001/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126589rbr-0001/",
                                "name": "Rolex Cosmograph Daytona de Oyster, 40 mm, oro blanco y diamantes, m126589rbr-0001 - GLAUSER",
                                ...
                                "description": "Descubra el reloj Rolex Cosmograph Daytona de Oyster, 40 mm, oro blanco y diamantes en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126589rbr-0001/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126589rbr-0001/"] }]
                            }
                        ]
                    `}
                ...
                {`
                        ...
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Cosmograph Daytona de Oyster, 40 mm, oro blanco y diamantes en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m126589rbr-0001",
                        "mpn": "126589RBR",
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126589rbr-0001/">m126589rbr-0001
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light block block">
                                            Oyster, 40 mm, oro blanco y diamantes
                                        </span>
                                        <span className="body-20-light">m126589rbr-0001</span>
                                    </h1>
                                ...
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slider">
                                        <picture className="rlx-pbanner-top p-relative">
                                            <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-drp-upright-bba-with-shadow-portrait.webp"/>
                                            <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-drp-upright-bba-with-shadow-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126589rbr-0001 reloj"/>
                                        </picture>
                                    </div>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-gallery1-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-gallery1-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126589rbr-0001 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-gallery2-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-gallery2-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126589rbr-0001 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-gallery3-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-gallery3-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126589rbr-0001 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-gallery4-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-gallery4-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126589rbr-0001 reloj galeria"/>
                                    </picture>
                                    </div>
                                </div>
                ...
                <section className="c-lightbeige-bg d-none-md">
                    ...
                    <div id="lightbox" className="lightbox">
                        ...
                        <div className="lightbox-content">
                            ...
                            <img id="lightbox-image" src="" alt="m126589rbr-0001 reloj galeria"/>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                            <div className="row-grid-6-12-7 pt-90-60 cuerpotextobeigebg">
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">126589RBR</span>
                                        </li>
                                        <li>
                                            <span className="body-20-bold block">Modelo caja</span>
                                            <span className="body-20-light">Oyster, 40 mm, oro blanco y diamantes</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">Engastado de diamantes</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Nácar blanco y negro, engastada de diamantes</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-6-12-7 border-top-brown p-relative" style={{ marginTop: "30px" }}>
                                    <div className="p-absolutes">
                                        <a href="https://assets.rolex.com/api/brochure/es/cosmograph-daytona/m126589rbr-0001.pdf" target="_blank" className="btn-primary-icon-rlx">
                            ...
                            <div className="col-6-6-5-3 order-1-mob"  style={{ display: "none" }}>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-cor-specs-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-cor-specs-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126589rbr-0001 especificaciones"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126589rbr-0001-bracelet-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126589rbr-0001-bracelet-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126589rbr-0001 bisel"/>
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">Esfera Nácar</p>
                                <p className="body-20-light pb-30">La esfera contrastada está realizada en nácar natural y engastada de ocho diamantes y tres índices Chromalight. La fuerza de los contrastes, la intensidad de los colores y la profundidad de los reflejos son fruto de un proceso de selección del material sumamente riguroso. Estas dos variedades de nácar son trabajadas con el mayor de los cuidados por los artesanos de la marca.</p>
                                <p className="body-20-light">La esfera permite a los pilotos planificar con precisión sus tiempos y tácticas sin ningún tipo de error.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126589rbr-0001-dial-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126589rbr-0001-dial-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126589rbr-0001 esfera"/>
                                    </picture>
                                </div>
                                <div className="pb-90-60">
                                    <p className="headline50 c-brown-text pb-20">Oro blanco de 18 quilates</p>
                                    <p className="body-20-light">Rolex cuenta con su propia fundición, lo que le ha permitido crear aleaciones de oro de 18 quilates de la más alta calidad. Según la proporción de plata, cobre, platino o paladio, se obtienen diferentes tipos de oro de 18 quilates: amarillo, rosa o blanco. Son elaborados exclusivamente con los metales más puros y sometidos a las más meticulosas inspecciones en un laboratorio interno con tecnología puntera, antes de formar el oro y con la misma atención que se presta a la calidad. El compromiso de Rolex con la calidad empieza desde el origen.</p>
                                </div>
                            </div>
                        </div>
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126589rbr-0001-material-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126589rbr-0001-material-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126589rbr-0001 material"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            ...
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Cosmograph Daytona m126589rbr-0001 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126589rbr-0001-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
