                                ...
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Nícar blanco y negro, engastada de diamantes</span>
                                        </li>
                                        <li>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">El nuevo Cosmograph Daytona está provisto de un brazalete Oysterflex, desarrollado y patentado por Rolex. Su interior está compuesto por una límina metílica superelística sobremoldeada con elastímero negro de alto rendimiento. Este material posee una gran duración y resiste particularmente bien a las agresiones ambientales. En su versión Oysterflex, el brazalete está provisto también de un cierre de seguridad Oysterlock y cuenta además con el sistema de extensiín rípida Easylink, patentado por Rolex, que permite ajustar fícilmente su longitud en 5 mm aproximadamente, con el fin de ofrecer una comodidad íptima en todas las situaciones.</p>
                                ...
                                <p className="body-20-light pb-30">La esfera contrastada está realizada en nícar natural y engastada de ocho diamantes y tres índices Chromalight. La fuerza de los contrastes, la intensidad de los colores y la profundidad de los reflejos son fruto de un proceso de selección del material sumamente riguroso. Estas dos variedades de nícar son trabajadas con el mayor de los cuidados por los artesanos de la marca.</p>
                                <p className="body-20-light">La esfera permite a los pilotos planificar con precisión sus tiempos y tícticas sin ningín tipo de error.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
