...
const M126519ln0006: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Cosmograph Daytona de Oyster, 40 mm, oro blanco, m126519ln-0006 - GLAUSER</title>
                <meta
                    name="description"
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126519ln-0006/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126519ln-0006/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Cosmograph Daytona de Oyster, 40 mm, oro blanco, m126519ln-0006 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126519ln-0006/" />
                <meta
                    name="twitter:title"
                    content="Rolex Cosmograph Daytona de Oyster, 40 mm, oro blanco, m126519ln-0006 - GLAUSER"
                />
                ...
                {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126519ln-0006/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126519ln-0006/",
                                "name": "Rolex Cosmograph Daytona de Oyster, 40 mm, oro blanco, m126519ln-0006 - GLAUSER",
                                ...
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126519ln-0006/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126519ln-0006/"] }]
                            }
                        ]
                    `}
                ...
                {`
                        ...
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Cosmograph Daytona de Oyster, 40 mm, oro blanco en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m126519ln-0006",
                        "mpn": "126519LN",
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126519ln-0006/">m126500ln-0001
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="col-6-4-3 pb-90-60">
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light">m126519ln-0006</span>
                                    </h1>
                                ...
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slider">
                                        <picture className="rlx-pbanner-top p-relative">
                                            <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-drp-upright-bba-with-shadow-portrait.webp"/>
                                            <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-drp-upright-bba-with-shadow-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126519ln-0006 reloj"/>
                                        </picture>
                                    </div>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-gallery1-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-gallery1-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126519ln-0006 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-gallery2-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-gallery2-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126519ln-0006 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-gallery3-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-gallery3-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126519ln-0006 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-gallery4-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-gallery4-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126519ln-0006 reloj galeria"/>
                                    </picture>
                                    </div>
                                </div>
                ...
                <section className="c-lightbeige-bg d-none-md">
                    ...
                    <div id="lightbox" className="lightbox">
                        ...
                        <div className="lightbox-content">
                            ...
                            <img id="lightbox-image" src="" alt="m126519ln-0006 reloj galeria"/>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                            <div className="row-grid-6-12-7 pt-90-60 cuerpotextobeigebg">
                                ...
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Acero y negro vivo</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-6-12-7 border-top-brown p-relative" style={{ marginTop: "30px" }}>
                                    <div className="p-absolutes">
                                        <a href="https://assets.rolex.com/api/brochure/es/cosmograph-daytona/m126519ln-0006.pdf" target="_blank" className="btn-primary-icon-rlx">
                            ...
                            <div className="col-6-6-5-3 order-1-mob"  style={{ display: "none" }}>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-cor-specs-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-cor-specs-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126519ln-0006 especificaciones"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                ...
                <section className="c-lightbeige-bg">
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126519ln-0006-bracelet-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126519ln-0006-bracelet-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126519ln-0006 bisel"/>
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">Esfera acero y negro vivo</p>
                                <p className="body-20-light">Este modelo presenta una esfera acero y negro vivo con unos índices en aplique de oro de 18 quilates y agujas con visualización Chromalight, un material luminiscente de alta legibilidad. La esfera permite a los pilotos planificar con precisión sus tiempos y tácticas sin ningún tipo de error.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126519ln-0006-dial-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126519ln-0006-dial-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126519ln-0006 esfera"/>
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126519ln-0006-material-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126519ln-0006-material-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126519ln-0006 material"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            ...
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Cosmograph Daytona m126519ln-0006 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126519ln-0006-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
