                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">Cerachrom monobloque en cerámica negra con escala taquimítrica moldeada</span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-3-5-3-2">
                                    <ul className="list-especification-model-rlx ">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">Perpetual, cronígrafo mecúnico, de cuerda automática</span>
                                        </li>
                                        <li>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <div className="pb-90-60">
                                    ...
                                    <p className="body-20-light">El nuevo CosmographíDaytona está provisto de un brazaleteíOysterflex, desarrollado y patentado por Rolex. Su interior está compuesto por una límina metílica superelística sobremoldeada con elastímero negro de alto rendimiento. Este material posee una gran duración y resiste particularmente bien a las agresiones ambientales. En su versión Oysterflex, el brazalete está provisto también de un cierre de seguridadíOysterlock y cuenta además con el sistema de extensiín rípida Easylink, patentado por Rolex, que permite ajustar fícilmente su longitud en 5ímm aproximadamente, con el fin de ofrecer una comodidad íptima en todas las situaciones.</p>
                                </div>
                            </div>
                        </div>
                        <div className="row-grid-fullw cuerpotexto">
