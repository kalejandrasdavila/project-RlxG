...
const M1265050005: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Rolex Cosmograph Daytona de Oyster, 40 mm, oro Everose, m126505-0005 - GLAUSER</title>
                <meta
                    name="description"
                ...
                <link rel="canonical" href="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126505-0005/" />

                {/* Facebook Meta Tags */}
                <meta property="og:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126505-0005/" />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content="Rolex Cosmograph Daytona de Oyster, 40 mm, oro Everose, m126505-0005 - GLAUSER"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-drp-upright-bba-with-shadow-landscape.webp"
                />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126505-0005/" />
                <meta
                    name="twitter:title"
                    content="Rolex Cosmograph Daytona de Oyster, 40 mm, oro Everose, m126505-0005 - GLAUSER"
                />
                ...
                {`
                        ...
                        "@graph": [
                            ...
                            {
                                "@type": "WebPage",
                                "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126505-0005/#webpage",
                                "url": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126505-0005/",
                                "name": "Rolex Cosmograph Daytona de Oyster, 40 mm, oro Everose, m126505-0005 - GLAUSER",
                                ...
                                "breadcrumb": { "@id": "https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126505-0005/#breadcrumb" },
                                "inLanguage": "es-Es",
                                "potentialAction": [{ "@type": "ReadAction", "target": ["https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126505-0005/"] }]
                            }
                        ]
                    `}
                ...
                {`
                        ...
                        "image": [
                            "https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-drp-upright-bba-with-shadow-landscape.webp"
                        ],
                        "description": "Descubra el reloj Rolex Cosmograph Daytona de Oyster, 40 mm, oro Everose en GLAUSER, Distribuidor Oficial Rolex autorizado para vender y realizar el mantenimiento de los relojes Rolex",
                        "sku": "m126505-0005",
                        "mpn": "126505",
                            ...
                            <div className="breadcrum-column">
                                <ul className="breadcrum-menu-list description">
                                    ...
                                    <li className="fixed-14 none-mobil">
                                        <a
                                            className="active"
                                            href="https://devjhernandez--glauser.myvtex.com/rolex/watches/cosmograph-daytona/m126505-0005/">m126505-0005
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="col-6-4-3 pb-90-60">
                                <div className="centered-content">
                                    <h1 className="mb-10 rolex-detail">
                                        ...
                                        <span className="body-20-light">m126505-0005</span>
                                    </h1>
                                ...
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slider">
                                        <picture className="rlx-pbanner-top p-relative">
                                            <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-drp-upright-bba-with-shadow-portrait.webp"/>
                                            <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-drp-upright-bba-with-shadow-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126505-0005 reloj"/>
                                        </picture>
                                    </div>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-gallery1-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-gallery1-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126505-0005 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-gallery2-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-gallery2-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126505-0005 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-gallery3-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-gallery3-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126505-0005 reloj galeria"/>
                                    </picture>
                                    </div>
                                    <div className="swiper-slide">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-gallery4-portrait.webp" />
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-gallery4-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126505-0005 reloj galeria"/>
                                    </picture>
                                    </div>
                                </div>
                ...
                <section className="c-lightbeige-bg d-none-md">
                    ...
                    <div id="lightbox" className="lightbox">
                        ...
                        <div className="lightbox-content">
                            ...
                            <img id="lightbox-image" src="" alt="m126505-0005 reloj galeria"/>
                    ...
                    <div className="rlx-container-content">
                        <div className="row-grid-fullw watch-caracteristicas cuerpotexto dispmodel">
                            <div className="row-grid-6-12-7 pt-90-60 cuerpotextobeigebg">
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        <li>
                                            ...
                                            <span className="body-20-light">126505</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">Fijo, con escala taquimétrica grabada, en oro Everose de 18 quilates</span>
                                        </li>
                                ...
                                <div className="col-3-5-3-3">
                                    <ul className="list-especification-model-rlx ">
                                        <li>
                                            ...
                                            <span className="body-20-light">Chocolate y negro vivo</span>
                                        </li>
                                        <li>
                                ...
                                <div className="col-6-12-7 border-top-brown p-relative" style={{ marginTop: "30px" }}>
                                    <div className="p-absolutes">
                                        <a href="https://assets.rolex.com/api/brochure/es/cosmograph-daytona/m126505-0005.pdf" target="_blank" className="btn-primary-icon-rlx">
                            ...
                            <div className="col-6-6-5-3 order-1-mob"  style={{ display: "none" }}>
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-cor-specs-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-cor-specs-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126505-0005 especificaciones"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                ...
                <section className="c-lightbeige-bg">
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126505-0005-bezel-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126505-0005-bezel-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126505-0005 bisel"/>
                                    </picture>
                                </div>
                                <p className="headline50 c-brown-text pb-20">Esfera chocolate</p>
                                <p className="body-20-light">Este modelo presenta una esfera chocolate y negra con contadores con círculos concéntricos, unos índices en aplique de oro de 18 quilates y agujas con visualización Chromalight, un material luminiscente de alta legibilidad. La esfera permite a los pilotos planificar con precisión sus tiempos y tácticas sin ningún tipo de error.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126505-0005-dial-portrait.webp"/>
                                        <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126505-0005-dial-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126505-0005 esfera"/>
                                    </picture>
                                </div>
                        ...
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126505-0005-material-portrait.webp"/>
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-espec/m126505-0005-material-landscape.webp" loading="lazy" alt="Rolex Cosmograph Daytona m126505-0005 material"/>
                                </picture>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-text-center">
                                    ...
                                    <picture className="rlx-pbanner-top p-relative" style={{ display: "none", }}>
                                        <source
                                            ...
                                            srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-presentation-box-portrait.webp"
                                        />
                                        <img
                                            alt="Rolex Cosmograph Daytona m126505-0005 caja presentación"
                                            loading="lazy"
                                            src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/watches-models/m126505-0005-presentation-box-landscape.webp"
                                        />
                                    </picture>
                                </div>
                            </div>
