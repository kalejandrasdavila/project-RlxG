                                ...
                                <div className="col-3-5-3-1">
                                    <ul className="list-especification-model-rlx">
                                        ...
                                        <li>
                                            ...
                                            <span className="body-20-light">
                                                Fijo, con escala taquimítrica grabada, en oro amarillo de 18
                                                quilates
                                            </span>
                                        </li>
                                    </ul>
                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">
                                    Con su escala taquimítrica, sus tres contadores y sus pulsadores, el
                                    Cosmograph Daytona se creí para ser la mejor herramienta de
                                    cronometraje de los pilotos de resistencia. El bisel presenta una
                                    escala taquimítrica que permite leer la velocidad media en una
                                    distancia determinada en función del tiempo cronometrado. Esta escala
                                    ofrece una legibilidad íptima, lo que convierte el Cosmograph Daytona
                                    en el instrumento perfecto para medir la velocidad hasta las
                                    400íunidades por hora, ya se trate de kilímetros o millas.
                                </p>
                                ...
                                <p className="body-20-light pb-30">
                                    Este modelo presenta una esfera negro vivo y dorada, engastada de diamantes con contadores pulverizados, índices en aplique de oro de 18íquilates y agujas con visualización Chromalight, un material luminiscente de alta legibilidad.
                                </p>
                                <p className="body-20-light">
                                    La esfera permite a los pilotos planificar con precisión sus tiempos y
                                    tícticas sin ningín tipo de error.
                                </p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
                                        <source
