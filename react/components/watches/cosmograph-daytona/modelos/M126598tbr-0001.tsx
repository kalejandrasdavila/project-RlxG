                    ...
                    <div className="rlx-container-content py-90-60">
                        <div className="row-grid-fullw cuerpotexto">
                            <div className="col-text-center">
                                ...
                                <p className="body-20-light">Este cronígrafo que ahora se ha convertido en legendario es el instrumento ideal para medir un intervalo de tiempo y determinar la velocidad media. En esta versión engastada, la emblemítica escala taquimítrica se sustituye por diamantes.</p>
                                <div className="pb-45-40">
                                    <picture className="rlx-pbanner-top p-relative">
