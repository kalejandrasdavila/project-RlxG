...
const MundoRlx: React.FC = () => {
    ...
    const currentUrl = (typeof window !== 'undefined' && window.location) ? window.location.href : `${baseUrl}/rolex/mundo-rolex/`;
    ...
    useEffect(() => {
        ...
        // Configurar título
        document.title = 'El mundo de Rolex - GLAUSER';
        ...
        // Meta tags básicos
        setMetaTag('description', 'Explora el mundo de Rolex. Descubra ideas y artículos que muestran la esencia de Rolex y manténgase actualizado con las últimas noticias de Rolex | GLAUSER.');
        ...
        setMetaTag('', 'El mundo de Rolex - GLAUSER', 'og:title');
        setMetaTag('', 'Explora el mundo de Rolex. Descubra ideas y artículos que muestran la esencia de Rolex y manténgase actualizado con las últimas noticias de Rolex | GLAUSER.', 'og:description');
        setMetaTag('', 'https://glauser.vteximg.com.br/arquivos/mundo-rolex-1200x630.jpg', 'og:image');

        // Twitter
        setMetaTag('twitter:card', 'summary_large_image');
        setMetaTag('twitter:site', '@glauser_col');
        setMetaTag('twitter:url', currentUrl);
        setMetaTag('twitter:title', 'El mundo de Rolex - GLAUSER');
        setMetaTag('twitter:description', 'Explora el mundo de Rolex. Descubra ideas y artículos que muestran la esencia de Rolex y manténgase actualizado con las últimas noticias de Rolex | GLAUSER.');
        setMetaTag('twitter:image', 'https://glauser.vteximg.com.br/arquivos/mundo-rolex-1200x630.jpg');
        ...
        // Digital Data Layer
        if (document.head && !document.getElementById('digital-data-layer')) {
