                    ...
                    <div className={`${handles.rlx_container}`}>
                        <div className={`${handles.breadcrum_column}`}>
                            <nav className={`${handles.breadcrum_menu_list}`}>
                                ...
                                <span className={`${handles.description} ${handles.fixed_14} ${handles.active}`} style={{ color: '#61bd93' }}>Nuevos Modelos 2024</span>
                            </nav>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="row-grid-fullw">
                            <div className="grid-column-full">
                                <picture className="rlx-pbanner-top p-relative">
                                    <source media="(max-width: 767px)" srcSet="https://galileo.tsqsa.com/FTPImagenes/rolex-img/modelos-2025/rolex-new-watches-2025-the-land-dweller-hub-cover-m127334-0001-portrait.webp" />
                                    <img src="https://galileo.tsqsa.com/FTPImagenes/rolex-img/modelos-2025/rolex-new-watches-2025-the-land-dweller-hub-cover-m127334-0001-landscape.webp" loading="lazy" alt="Land-Dweller" />
                                </picture>
                            </div>
                        </div>
                    </div>
